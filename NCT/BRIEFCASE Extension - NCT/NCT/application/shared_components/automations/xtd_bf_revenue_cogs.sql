...
wwv_flow_imp_shared.create_automation(
 p_id=>wwv_flow_imp.id(31046382056283277)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(31046650045283415)
,p_automation_id=>wwv_flow_imp.id(31046382056283277)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(31047681615311352)
,p_automation_id=>wwv_flow_imp.id(31046382056283277)
