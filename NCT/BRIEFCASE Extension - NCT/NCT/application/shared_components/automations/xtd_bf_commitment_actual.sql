...
wwv_flow_imp_shared.create_automation(
 p_id=>wwv_flow_imp.id(29209096811529932)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(29209399920530249)
,p_automation_id=>wwv_flow_imp.id(29209096811529932)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(29210272926539819)
,p_automation_id=>wwv_flow_imp.id(29209096811529932)
