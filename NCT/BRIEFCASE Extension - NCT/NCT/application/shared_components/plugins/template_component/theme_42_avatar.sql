...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(774713455615625103)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774713787806625186)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774714062074625197)
,p_plugin_attribute_id=>wwv_flow_imp.id(774713787806625186)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774714429993625205)
,p_plugin_attribute_id=>wwv_flow_imp.id(774713787806625186)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774714865021625206)
,p_plugin_attribute_id=>wwv_flow_imp.id(774713787806625186)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774715243520625216)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(774713787806625186)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774715535575625218)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774715916132625218)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774716194127625218)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774716505669625218)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774716776773625219)
,p_plugin_attribute_id=>wwv_flow_imp.id(774716505669625218)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774717185683625219)
,p_plugin_attribute_id=>wwv_flow_imp.id(774716505669625218)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774717558506625219)
,p_plugin_attribute_id=>wwv_flow_imp.id(774716505669625218)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774717942409625220)
,p_plugin_attribute_id=>wwv_flow_imp.id(774716505669625218)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774718387281625220)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774718643926625220)
,p_plugin_attribute_id=>wwv_flow_imp.id(774718387281625220)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774719084150625221)
,p_plugin_attribute_id=>wwv_flow_imp.id(774718387281625220)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774719424837625221)
,p_plugin_attribute_id=>wwv_flow_imp.id(774718387281625220)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774719916403625221)
,p_plugin_attribute_id=>wwv_flow_imp.id(774718387281625220)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774720257406625221)
,p_plugin_attribute_id=>wwv_flow_imp.id(774718387281625220)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774720686659625222)
,p_plugin_attribute_id=>wwv_flow_imp.id(774718387281625220)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774721114172625222)
,p_plugin_attribute_id=>wwv_flow_imp.id(774718387281625220)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774721504951625222)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2574764297646738857)
,p_plugin_id=>wwv_flow_imp.id(774713455615625103)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
