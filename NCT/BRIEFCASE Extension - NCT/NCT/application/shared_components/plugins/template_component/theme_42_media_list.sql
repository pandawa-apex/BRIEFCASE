...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(774738974242625373)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2574757305389509025)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2574756750377509024)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774739694972625377)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774739942053625377)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774740265564625377)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774740597724625378)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774740906216625378)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(774740265564625377)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2574757305389509025)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774741172643625378)
,p_plugin_attribute_id=>wwv_flow_imp.id(774740906216625378)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774741554918625379)
,p_plugin_attribute_id=>wwv_flow_imp.id(774740906216625378)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774741973896625379)
,p_plugin_attribute_id=>wwv_flow_imp.id(774740906216625378)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774742325246625379)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(774740906216625378)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774742706739625379)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774742994220625380)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774743316784625380)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774743602412625380)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774743825488625380)
,p_plugin_attribute_id=>wwv_flow_imp.id(774743602412625380)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774744309395625381)
,p_plugin_attribute_id=>wwv_flow_imp.id(774743602412625380)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774744682553625381)
,p_plugin_attribute_id=>wwv_flow_imp.id(774743602412625380)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774745066856625381)
,p_plugin_attribute_id=>wwv_flow_imp.id(774743602412625380)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774745459477625382)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(774740597724625378)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2574756750377509024)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774745813540625382)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774746096689625382)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774746339588625382)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774746711737625382)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774746947095625383)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774747308934625383)
,p_plugin_attribute_id=>wwv_flow_imp.id(774746947095625383)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774747653714625383)
,p_plugin_attribute_id=>wwv_flow_imp.id(774746947095625383)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774748109839625384)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774748321103625384)
,p_plugin_attribute_id=>wwv_flow_imp.id(774748109839625384)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774748759494625384)
,p_plugin_attribute_id=>wwv_flow_imp.id(774748109839625384)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774749142167625385)
,p_plugin_attribute_id=>wwv_flow_imp.id(774748109839625384)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774749614777625385)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774751099243625386)
,p_plugin_attribute_id=>wwv_flow_imp.id(774749614777625385)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774751445109625387)
,p_plugin_attribute_id=>wwv_flow_imp.id(774749614777625385)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774749879561625385)
,p_plugin_attribute_id=>wwv_flow_imp.id(774749614777625385)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774750231953625385)
,p_plugin_attribute_id=>wwv_flow_imp.id(774749614777625385)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774750678135625386)
,p_plugin_attribute_id=>wwv_flow_imp.id(774749614777625385)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774751892404625387)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774752169260625387)
,p_plugin_attribute_id=>wwv_flow_imp.id(774751892404625387)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774752605018625387)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2574960357546655653)
,p_plugin_id=>wwv_flow_imp.id(774738974242625373)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
