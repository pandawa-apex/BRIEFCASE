...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(774728701524625351)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2574614147029657069)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774729175957625353)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774729420360625354)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774729724296625354)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774730059091625354)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774730334740625355)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(774734929473625365)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2574614147029657069)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774730707235625355)
,p_plugin_attribute_id=>wwv_flow_imp.id(774730334740625355)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774731036394625355)
,p_plugin_attribute_id=>wwv_flow_imp.id(774730334740625355)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774731434341625355)
,p_plugin_attribute_id=>wwv_flow_imp.id(774730334740625355)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774731821711625356)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(774730334740625355)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774732156975625356)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774732478455625356)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774732769822625356)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774733045784625357)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774733391865625357)
,p_plugin_attribute_id=>wwv_flow_imp.id(774733045784625357)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774733802688625357)
,p_plugin_attribute_id=>wwv_flow_imp.id(774733045784625357)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774734178154625363)
,p_plugin_attribute_id=>wwv_flow_imp.id(774733045784625357)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774734586459625364)
,p_plugin_attribute_id=>wwv_flow_imp.id(774733045784625357)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774734929473625365)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774735256802625366)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774735532535625366)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774735893945625366)
,p_plugin_attribute_id=>wwv_flow_imp.id(774735532535625366)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774736315785625367)
,p_plugin_attribute_id=>wwv_flow_imp.id(774735532535625366)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774736701555625367)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2574746814462758572)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2574746222957751115)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2574801846627732994)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2574954064340603765)
,p_plugin_id=>wwv_flow_imp.id(774728701524625351)
