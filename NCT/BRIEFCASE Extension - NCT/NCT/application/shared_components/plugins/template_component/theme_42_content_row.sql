...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(774758400813625433)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2701996165332697131)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2701995610320697130)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2445103546590423617)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774759295895625438)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774759566200625438)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774759892210625439)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774760171021625440)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774760510525625440)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774760804583625441)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774761072242625441)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(774760510525625440)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2701996165332697131)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774761371048625441)
,p_plugin_attribute_id=>wwv_flow_imp.id(774761072242625441)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774761790808625442)
,p_plugin_attribute_id=>wwv_flow_imp.id(774761072242625441)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774762148093625442)
,p_plugin_attribute_id=>wwv_flow_imp.id(774761072242625441)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774762577293625443)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(774761072242625441)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774762843132625443)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774763170067625444)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774763517283625444)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774763782078625444)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774764049821625445)
,p_plugin_attribute_id=>wwv_flow_imp.id(774763782078625444)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774764467717625445)
,p_plugin_attribute_id=>wwv_flow_imp.id(774763782078625444)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774764902779625446)
,p_plugin_attribute_id=>wwv_flow_imp.id(774763782078625444)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774765261797625446)
,p_plugin_attribute_id=>wwv_flow_imp.id(774763782078625444)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774765680050625446)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(774760804583625441)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2701995610320697130)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774765937047625447)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774766240393625447)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774766543568625448)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774766824703625449)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774767162047625449)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774767464481625450)
,p_plugin_attribute_id=>wwv_flow_imp.id(774767162047625449)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774767886099625450)
,p_plugin_attribute_id=>wwv_flow_imp.id(774767162047625449)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774768310848625451)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774768565926625451)
,p_plugin_attribute_id=>wwv_flow_imp.id(774768310848625451)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774769016981625451)
,p_plugin_attribute_id=>wwv_flow_imp.id(774768310848625451)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774769375483625452)
,p_plugin_attribute_id=>wwv_flow_imp.id(774768310848625451)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774769746312625452)
,p_plugin_attribute_id=>wwv_flow_imp.id(774768310848625451)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774770210220625452)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774770429108625453)
,p_plugin_attribute_id=>wwv_flow_imp.id(774770210220625452)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774770830871625453)
,p_plugin_attribute_id=>wwv_flow_imp.id(774770210220625452)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774771228496625453)
,p_plugin_attribute_id=>wwv_flow_imp.id(774770210220625452)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774771640178625453)
,p_plugin_attribute_id=>wwv_flow_imp.id(774770210220625452)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774772060434625454)
,p_plugin_attribute_id=>wwv_flow_imp.id(774770210220625452)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774772429669625454)
,p_plugin_attribute_id=>wwv_flow_imp.id(774770210220625452)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774772874869625455)
,p_plugin_attribute_id=>wwv_flow_imp.id(774770210220625452)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774773271778625455)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774773587107625456)
,p_plugin_attribute_id=>wwv_flow_imp.id(774773271778625455)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774773955638625456)
,p_plugin_attribute_id=>wwv_flow_imp.id(774773271778625455)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774774415005625456)
,p_plugin_attribute_id=>wwv_flow_imp.id(774773271778625455)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774774768040625457)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774775070882625457)
,p_plugin_attribute_id=>wwv_flow_imp.id(774774768040625457)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774775426011625458)
,p_plugin_attribute_id=>wwv_flow_imp.id(774774768040625457)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774775905151625458)
,p_plugin_attribute_id=>wwv_flow_imp.id(774774768040625457)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774776274432625458)
,p_plugin_attribute_id=>wwv_flow_imp.id(774774768040625457)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774776716441625459)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774776994516625459)
,p_plugin_attribute_id=>wwv_flow_imp.id(774776716441625459)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774777367674625459)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774777671266625460)
,p_plugin_attribute_id=>wwv_flow_imp.id(774777367674625459)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774778102187625460)
,p_plugin_attribute_id=>wwv_flow_imp.id(774777367674625459)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774778464125625460)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(2445103546590423617)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774778791565625461)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(774779085908625461)
,p_plugin_attribute_id=>wwv_flow_imp.id(774778791565625461)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774779444828625461)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(774779804490625462)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2583210055548518745)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2583211315068522893)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2286258540652760315)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2569616426874112012)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2570295727604195116)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2583208120481473759)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2583209453871487616)
,p_plugin_id=>wwv_flow_imp.id(774758400813625433)
