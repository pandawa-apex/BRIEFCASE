...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(774557307287624742)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774557578640624742)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774557883938624742)
,p_page_template_id=>wwv_flow_imp.id(774557307287624742)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774558120675624742)
,p_page_template_id=>wwv_flow_imp.id(774557307287624742)
