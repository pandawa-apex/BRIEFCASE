...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(774535798408624618)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774536072310624675)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774536398229624677)
,p_page_template_id=>wwv_flow_imp.id(774535798408624618)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774536639233624677)
,p_page_template_id=>wwv_flow_imp.id(774535798408624618)
