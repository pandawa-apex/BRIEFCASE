...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774600331148624801)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774600680132624801)
,p_plug_template_id=>wwv_flow_imp.id(774600331148624801)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774600931652624802)
,p_plug_template_id=>wwv_flow_imp.id(774600331148624801)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774601245796624802)
,p_plug_template_id=>wwv_flow_imp.id(774600331148624801)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774601582558624802)
,p_plug_template_id=>wwv_flow_imp.id(774600331148624801)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774601899435624802)
,p_plug_template_id=>wwv_flow_imp.id(774600331148624801)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774602183517624802)
,p_plug_template_id=>wwv_flow_imp.id(774600331148624801)
,p_name=>'Sub Regions'
