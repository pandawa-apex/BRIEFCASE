...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774650625947624824)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774650992830624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774651297986624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774651607402624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774651881639624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774652135368624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774652488869624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774652735570624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774653043961624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774653399534624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774653708573624825)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774654017801624826)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774654295988624826)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774654600130624826)
,p_plug_template_id=>wwv_flow_imp.id(774650625947624824)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
