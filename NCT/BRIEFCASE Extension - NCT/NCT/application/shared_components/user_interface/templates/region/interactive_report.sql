...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774628479150624817)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774628747952624817)
,p_plug_template_id=>wwv_flow_imp.id(774628479150624817)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774629097434624817)
,p_plug_template_id=>wwv_flow_imp.id(774628479150624817)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774629409551624817)
,p_plug_template_id=>wwv_flow_imp.id(774628479150624817)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774629652308624817)
,p_plug_template_id=>wwv_flow_imp.id(774628479150624817)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774629989910624817)
,p_plug_template_id=>wwv_flow_imp.id(774628479150624817)
,p_name=>'Sub Regions'
