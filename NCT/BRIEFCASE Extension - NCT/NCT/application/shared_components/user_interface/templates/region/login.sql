...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774633028547624819)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774633333714624819)
,p_plug_template_id=>wwv_flow_imp.id(774633028547624819)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774633676703624819)
,p_plug_template_id=>wwv_flow_imp.id(774633028547624819)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774633924382624819)
,p_plug_template_id=>wwv_flow_imp.id(774633028547624819)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774634226359624819)
,p_plug_template_id=>wwv_flow_imp.id(774633028547624819)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774634554598624819)
,p_plug_template_id=>wwv_flow_imp.id(774633028547624819)
,p_name=>'Sub Regions'
