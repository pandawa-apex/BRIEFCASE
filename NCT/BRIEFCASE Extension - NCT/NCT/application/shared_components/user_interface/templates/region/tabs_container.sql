...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774648115065624823)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774648346213624824)
,p_plug_template_id=>wwv_flow_imp.id(774648115065624823)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774648642092624824)
,p_plug_template_id=>wwv_flow_imp.id(774648115065624823)
,p_name=>'Tabs'
