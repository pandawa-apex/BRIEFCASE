...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774630597420624818)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774630903824624818)
,p_plug_template_id=>wwv_flow_imp.id(774630597420624818)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774631142634624818)
,p_plug_template_id=>wwv_flow_imp.id(774630597420624818)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774631456688624818)
,p_plug_template_id=>wwv_flow_imp.id(774630597420624818)
,p_name=>'Button Start'
