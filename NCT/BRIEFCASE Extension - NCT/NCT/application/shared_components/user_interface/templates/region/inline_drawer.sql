...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774618442045624813)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774618788215624813)
,p_plug_template_id=>wwv_flow_imp.id(774618442045624813)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774619109737624813)
,p_plug_template_id=>wwv_flow_imp.id(774618442045624813)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774619388836624813)
,p_plug_template_id=>wwv_flow_imp.id(774618442045624813)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774619697170624813)
,p_plug_template_id=>wwv_flow_imp.id(774618442045624813)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774619971478624814)
,p_plug_template_id=>wwv_flow_imp.id(774618442045624813)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774620275295624814)
,p_plug_template_id=>wwv_flow_imp.id(774618442045624813)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774620548572624814)
,p_plug_template_id=>wwv_flow_imp.id(774618442045624813)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774620830479624814)
,p_plug_template_id=>wwv_flow_imp.id(774618442045624813)
,p_name=>'Sub Regions'
