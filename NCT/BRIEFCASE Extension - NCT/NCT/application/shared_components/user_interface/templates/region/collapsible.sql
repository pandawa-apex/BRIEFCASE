...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774590586090624797)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774590907469624797)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774591206483624797)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774591506999624797)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774591758714624797)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774592063852624797)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774592417021624798)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774592686129624798)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774592954052624798)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774593268442624798)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774593617245624798)
,p_plug_template_id=>wwv_flow_imp.id(774590586090624797)
,p_name=>'Sub Regions'
