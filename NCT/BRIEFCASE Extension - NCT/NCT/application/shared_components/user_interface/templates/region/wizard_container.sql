...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774655771488624826)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774656068507624826)
,p_plug_template_id=>wwv_flow_imp.id(774655771488624826)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774656409265624826)
,p_plug_template_id=>wwv_flow_imp.id(774655771488624826)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774656650405624826)
,p_plug_template_id=>wwv_flow_imp.id(774655771488624826)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774656996510624826)
,p_plug_template_id=>wwv_flow_imp.id(774655771488624826)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774657316813624827)
,p_plug_template_id=>wwv_flow_imp.id(774655771488624826)
