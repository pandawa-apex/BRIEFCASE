...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774604989378624804)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774605310744624807)
,p_plug_template_id=>wwv_flow_imp.id(774604989378624804)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774605604050624807)
,p_plug_template_id=>wwv_flow_imp.id(774604989378624804)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774605889973624807)
,p_plug_template_id=>wwv_flow_imp.id(774604989378624804)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774606141381624807)
,p_plug_template_id=>wwv_flow_imp.id(774604989378624804)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774606434920624808)
,p_plug_template_id=>wwv_flow_imp.id(774604989378624804)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
