...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774573099164624786)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774573348502624786)
,p_plug_template_id=>wwv_flow_imp.id(774573099164624786)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774573695700624786)
,p_plug_template_id=>wwv_flow_imp.id(774573099164624786)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774573991247624786)
,p_plug_template_id=>wwv_flow_imp.id(774573099164624786)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774574317175624786)
,p_plug_template_id=>wwv_flow_imp.id(774573099164624786)
,p_name=>'Sub Regions'
