...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774578723088624788)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774579093567624788)
,p_plug_template_id=>wwv_flow_imp.id(774578723088624788)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774579335285624788)
,p_plug_template_id=>wwv_flow_imp.id(774578723088624788)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774579640661624788)
,p_plug_template_id=>wwv_flow_imp.id(774578723088624788)
,p_name=>'Sub Regions'
