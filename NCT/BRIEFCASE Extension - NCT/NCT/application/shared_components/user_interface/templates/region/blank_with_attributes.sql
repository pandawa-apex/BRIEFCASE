...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774571699333624785)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774571967404624785)
,p_plug_template_id=>wwv_flow_imp.id(774571699333624785)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774572252427624786)
,p_plug_template_id=>wwv_flow_imp.id(774571699333624785)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774572543151624786)
,p_plug_template_id=>wwv_flow_imp.id(774571699333624785)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774572904225624786)
,p_plug_template_id=>wwv_flow_imp.id(774571699333624785)
,p_name=>'Sub Regions'
