...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(774635564967624819)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774635849009624819)
,p_plug_template_id=>wwv_flow_imp.id(774635564967624819)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774636192651624820)
,p_plug_template_id=>wwv_flow_imp.id(774635564967624819)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(774636462484624820)
,p_plug_template_id=>wwv_flow_imp.id(774635564967624819)
,p_name=>'Sub Regions'
