...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(29571022632022196)
,p_name=>'BF - User Comp Access'
,p_static_id=>'bf_user_comp_access'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(29566084490022192)
...
,p_credential_id=>wwv_flow_imp.id(29565718551022192)
...
,p_version_scn=>39509931065411
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(29571624424022197)
,p_web_src_module_id=>wwv_flow_imp.id(29571022632022196)
,p_name=>'company'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(29571276381022197)
,p_web_src_module_id=>wwv_flow_imp.id(29571022632022196)
,p_operation=>'GET'
