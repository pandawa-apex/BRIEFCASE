...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(775031953934790077)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(775054741667624188)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(775056422343624232)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(775031953934790077)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(775057851538624236)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(775031953934790077)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(775057053790624236)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(775031953934790077)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(775057460681624236)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(775031953934790077)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(775031307840790070)
,p_name=>'P10_USERNAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(775054741667624188)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(775055096171624188)
,p_name=>'P10_ID'
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(775054741667624188)
,p_item_source_plug_id=>wwv_flow_imp.id(775054741667624188)
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(775055420870624224)
,p_name=>'P10_TITLE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(775031333232790071)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(775056422343624232)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(775031452351790072)
,p_event_id=>wwv_flow_imp.id(775031333232790071)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(775059027925624247)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(775054741667624188)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(775031522467790073)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(775057851538624236)
,p_process_success_message=>'Hak Akses sudah dibuat'
,p_internal_uid=>143196702848125723
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(775031744566790075)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(775057460681624236)
,p_process_success_message=>'Hak akses sudah diperbarui'
,p_internal_uid=>143196924947125725
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(775031897008790076)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(775057053790624236)
,p_process_success_message=>'Hak Akses sudah dihapus'
,p_internal_uid=>143197077389125726
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(775031687244790074)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(775058659680624246)
,p_process_sequence=>10
