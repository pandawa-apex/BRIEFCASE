...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(775075961722848416)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(775076623550848436)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(775032046783790078)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(775032150752790079)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(775077963876848522)
,p_name=>'ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(775078888182848540)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(775079875840848541)
,p_name=>'DEPT_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(775077161176848455)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(775077611186848466)
,p_interactive_grid_id=>wwv_flow_imp.id(775077161176848455)
,p_static_id=>'1432428'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(775077756733848480)
,p_report_id=>wwv_flow_imp.id(775077611186848466)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(775078245941848535)
,p_view_id=>wwv_flow_imp.id(775077756733848480)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(775077963876848522)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(775079287033848540)
,p_view_id=>wwv_flow_imp.id(775077756733848480)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(775078888182848540)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(775080293390848541)
,p_view_id=>wwv_flow_imp.id(775077756733848480)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(775079875840848541)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(775082814497865948)
,p_view_id=>wwv_flow_imp.id(775077756733848480)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(775032046783790078)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(775032433381790082)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(775032604908790083)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(775032263377790080)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(775076623550848436)
