...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(39971966469414218)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(33744169769058889)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(774687266481624878)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(774835421242625966)
,p_plug_name=>'BRIEFCASE EXTENSION'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(774604989378624804)
,p_plug_display_sequence=>10
