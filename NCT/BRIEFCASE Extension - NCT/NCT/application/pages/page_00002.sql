...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(774847993063707640)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(774848625871707665)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(774850566554707684)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(774850989825707685)
,p_plug_name=>'Upload a File'
,p_parent_plug_id=>wwv_flow_imp.id(774850566554707684)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(774853043633707723)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(774855996868707742)
,p_name=>'Preview'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774856300395707820)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774856707235707823)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774857110162707823)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774857445147707824)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774857851131707824)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774858284161707824)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774858679174707825)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774859073835707825)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774859455668707825)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774859844287707825)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(774860268707707826)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(774864456225712951)
,p_plug_name=>'View'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(774864522028712952)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(774864661904712953)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(774864754096712954)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(774864877301712955)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(774865095195712957)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(774864956960712956)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(774918454067872322)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(774849083956707672)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(774848625871707665)
,p_button_name=>'CLEAR'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(774849407164707673)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(774851378016707691)
,p_name=>'P2_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(774850989825707685)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(774851752598707694)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(774853433624707725)
,p_name=>'P2_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(774853043633707723)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(774854622948707738)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(774854007831707731)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(774854381665707733)
...
,p_associated_item=>wwv_flow_imp.id(774851378016707691)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_required_patch=>wwv_flow_imp.id(774534465922624458)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(774852124113707694)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(774852631167707701)
,p_event_id=>wwv_flow_imp.id(774852124113707694)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(774855057205707741)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(774855525123707742)
,p_event_id=>wwv_flow_imp.id(774855057205707741)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(774849883929707674)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Load Data'
,p_attribute_01=>wwv_flow_imp.id(774847179621705059)
,p_attribute_02=>'FILE'
,p_attribute_03=>'P2_FILE'
,p_attribute_06=>'P2_XLSX_WORKSHEET'
,p_attribute_08=>'P2_ERROR_ROW_COUNT'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(774849407164707673)
,p_internal_uid=>143015064310043324
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(774865147414712958)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(774865224232712959)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(774850278024707684)
