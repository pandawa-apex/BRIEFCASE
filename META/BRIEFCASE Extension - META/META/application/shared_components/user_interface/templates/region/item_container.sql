...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512197807254912038)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512198113658912038)
,p_plug_template_id=>wwv_flow_imp.id(1512197807254912038)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512198352468912038)
,p_plug_template_id=>wwv_flow_imp.id(1512197807254912038)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512198666522912038)
,p_plug_template_id=>wwv_flow_imp.id(1512197807254912038)
,p_name=>'Button Start'
