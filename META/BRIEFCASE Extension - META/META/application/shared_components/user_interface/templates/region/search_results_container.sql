...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512202774801912039)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512203058843912039)
,p_plug_template_id=>wwv_flow_imp.id(1512202774801912039)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512203402485912040)
,p_plug_template_id=>wwv_flow_imp.id(1512202774801912039)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512203672318912040)
,p_plug_template_id=>wwv_flow_imp.id(1512202774801912039)
,p_name=>'Sub Regions'
