...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512172199212912024)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512172520578912027)
,p_plug_template_id=>wwv_flow_imp.id(1512172199212912024)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512172813884912027)
,p_plug_template_id=>wwv_flow_imp.id(1512172199212912024)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512173099807912027)
,p_plug_template_id=>wwv_flow_imp.id(1512172199212912024)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512173351215912027)
,p_plug_template_id=>wwv_flow_imp.id(1512172199212912024)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512173644754912028)
,p_plug_template_id=>wwv_flow_imp.id(1512172199212912024)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
