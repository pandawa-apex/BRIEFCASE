...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512140308998912006)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512140558336912006)
,p_plug_template_id=>wwv_flow_imp.id(1512140308998912006)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512140905534912006)
,p_plug_template_id=>wwv_flow_imp.id(1512140308998912006)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512141201081912006)
,p_plug_template_id=>wwv_flow_imp.id(1512140308998912006)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512141527009912006)
,p_plug_template_id=>wwv_flow_imp.id(1512140308998912006)
,p_name=>'Sub Regions'
