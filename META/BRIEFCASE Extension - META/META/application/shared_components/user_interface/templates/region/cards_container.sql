...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512145932922912008)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512146303401912008)
,p_plug_template_id=>wwv_flow_imp.id(1512145932922912008)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512146545119912008)
,p_plug_template_id=>wwv_flow_imp.id(1512145932922912008)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512146850495912008)
,p_plug_template_id=>wwv_flow_imp.id(1512145932922912008)
,p_name=>'Sub Regions'
