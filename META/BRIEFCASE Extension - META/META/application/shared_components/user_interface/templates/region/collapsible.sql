...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512157795924912017)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512158117303912017)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512158416317912017)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512158716833912017)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512158968548912017)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512159273686912017)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512159626855912018)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512159895963912018)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512160163886912018)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512160478276912018)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512160827079912018)
,p_plug_template_id=>wwv_flow_imp.id(1512157795924912017)
,p_name=>'Sub Regions'
