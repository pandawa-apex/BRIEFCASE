...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512200238381912039)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512200543548912039)
,p_plug_template_id=>wwv_flow_imp.id(1512200238381912039)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512200886537912039)
,p_plug_template_id=>wwv_flow_imp.id(1512200238381912039)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512201134216912039)
,p_plug_template_id=>wwv_flow_imp.id(1512200238381912039)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512201436193912039)
,p_plug_template_id=>wwv_flow_imp.id(1512200238381912039)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512201764432912039)
,p_plug_template_id=>wwv_flow_imp.id(1512200238381912039)
,p_name=>'Sub Regions'
