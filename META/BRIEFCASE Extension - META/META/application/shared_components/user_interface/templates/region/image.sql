...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512175676167912028)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512176006042912028)
,p_plug_template_id=>wwv_flow_imp.id(1512175676167912028)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512176237228912029)
,p_plug_template_id=>wwv_flow_imp.id(1512175676167912028)
,p_name=>'Sub Regions'
