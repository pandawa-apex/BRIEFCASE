...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1512185651879912033)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512185998049912033)
,p_plug_template_id=>wwv_flow_imp.id(1512185651879912033)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512186319571912033)
,p_plug_template_id=>wwv_flow_imp.id(1512185651879912033)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512186598670912033)
,p_plug_template_id=>wwv_flow_imp.id(1512185651879912033)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512186907004912033)
,p_plug_template_id=>wwv_flow_imp.id(1512185651879912033)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512187181312912034)
,p_plug_template_id=>wwv_flow_imp.id(1512185651879912033)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512187485129912034)
,p_plug_template_id=>wwv_flow_imp.id(1512185651879912033)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512187758406912034)
,p_plug_template_id=>wwv_flow_imp.id(1512185651879912033)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512188040313912034)
,p_plug_template_id=>wwv_flow_imp.id(1512185651879912033)
,p_name=>'Sub Regions'
