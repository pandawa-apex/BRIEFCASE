...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1512120338721911960)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512120639494911960)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512120952419911960)
,p_page_template_id=>wwv_flow_imp.id(1512120338721911960)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512121299196911961)
,p_page_template_id=>wwv_flow_imp.id(1512120338721911960)
