...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1512103008242911838)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512103282144911895)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512103608063911897)
,p_page_template_id=>wwv_flow_imp.id(1512103008242911838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512103849067911897)
,p_page_template_id=>wwv_flow_imp.id(1512103008242911838)
