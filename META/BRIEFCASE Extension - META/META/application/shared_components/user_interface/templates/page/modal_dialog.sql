...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1512124517121911962)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512124788474911962)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512125093772911962)
,p_page_template_id=>wwv_flow_imp.id(1512124517121911962)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512125330509911962)
,p_page_template_id=>wwv_flow_imp.id(1512124517121911962)
