...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1512121880747911961)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512122197681911961)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512122490220911961)
,p_page_template_id=>wwv_flow_imp.id(1512121880747911961)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512122794933911961)
,p_page_template_id=>wwv_flow_imp.id(1512121880747911961)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512123067434911961)
,p_page_template_id=>wwv_flow_imp.id(1512121880747911961)
,p_name=>'Body Footer'
