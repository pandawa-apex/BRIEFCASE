...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(1374199298310416978)
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(1374199907555416982)
,p_web_src_module_id=>wwv_flow_imp.id(1374199298310416978)
,p_name=>'company'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(1374199464865416980)
,p_web_src_module_id=>wwv_flow_imp.id(1374199298310416978)
,p_operation=>'GET'
