...
wwv_flow_imp_shared.create_automation(
 p_id=>wwv_flow_imp.id(1373733148786358796)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(1373733457835358865)
,p_automation_id=>wwv_flow_imp.id(1373733148786358796)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(1373735581823403428)
,p_automation_id=>wwv_flow_imp.id(1373733148786358796)
