...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1512325610647912653)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(3182670756424710837)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(3439563375166984351)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(3439562820154984350)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512326505729912658)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512326776034912658)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512327102044912659)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512327380855912660)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512327720359912660)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512328014417912661)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512328282076912661)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512327720359912660)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(3439563375166984351)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512328580882912661)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512328282076912661)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512329000642912662)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512328282076912661)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512329357927912662)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512328282076912661)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512329787127912663)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512328282076912661)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512330052966912663)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512330379901912664)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512330727117912664)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512330991912912664)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512331259655912665)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512330991912912664)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512331677551912665)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512330991912912664)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512332112613912666)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512330991912912664)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512332471631912666)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512330991912912664)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512332889884912666)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512328014417912661)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(3439562820154984350)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512333146881912667)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512333450227912667)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512333753402912668)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512334034537912669)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512334371881912669)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512334674315912670)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512334371881912669)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512335095933912670)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512334371881912669)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512335520682912671)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512335775760912671)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512335520682912671)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512336226815912671)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512335520682912671)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512336585317912672)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512335520682912671)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512336956146912672)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512335520682912671)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512337420054912672)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512337638942912673)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512337420054912672)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512338040705912673)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512337420054912672)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512338438330912673)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512337420054912672)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512338850012912673)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512337420054912672)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512339270268912674)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512337420054912672)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512339639503912674)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512337420054912672)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512340084703912675)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512337420054912672)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512340481612912675)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512340796941912676)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512340481612912675)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512341165472912676)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512340481612912675)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512341624839912676)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512340481612912675)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512341977874912677)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512342280716912677)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512341977874912677)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512342635845912678)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512341977874912677)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512343114985912678)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512341977874912677)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512343484266912678)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512341977874912677)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512343926275912679)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512344204350912679)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512343926275912679)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512344577508912679)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512344881100912680)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512344577508912679)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512345312021912680)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512344577508912679)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512345673959912680)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(3182670756424710837)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512346001399912681)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512346295742912681)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512346001399912681)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512346654662912681)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512347014324912682)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(3320777265382805965)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(3320778524902810113)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3023825750487047535)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3307183636708399232)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3307862937438482336)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3320775330315760979)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3320776663705774836)
,p_plugin_id=>wwv_flow_imp.id(1512325610647912653)
