...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1512295911358912571)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(3312181356863944289)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512296385791912573)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512296630194912574)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512296934130912574)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512297268925912574)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512297544574912575)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512302139307912585)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(3312181356863944289)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512297917069912575)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512297544574912575)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512298246228912575)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512297544574912575)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512298644175912575)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512297544574912575)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512299031545912576)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512297544574912575)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512299366809912576)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512299688289912576)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512299979656912576)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512300255618912577)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512300601699912577)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512300255618912577)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512301012522912577)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512300255618912577)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512301387988912583)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512300255618912577)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512301796293912584)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512300255618912577)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512302139307912585)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512302466636912586)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512302742369912586)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512303103779912586)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512302742369912586)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512303525619912587)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512302742369912586)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512303911389912587)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(3312314024297045792)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3312313432792038335)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3312369056462020214)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3312521274174890985)
,p_plugin_id=>wwv_flow_imp.id(1512295911358912571)
