...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1512306184076912593)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(3312324515223796245)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(3312323960211796244)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512306904806912597)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512307151887912597)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512307475398912597)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512307807558912598)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512308116050912598)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512307475398912597)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(3312324515223796245)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512308382477912598)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512308116050912598)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512308764752912599)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512308116050912598)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512309183730912599)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512308116050912598)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512309535080912599)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512308116050912598)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512309916573912599)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512310204054912600)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512310526618912600)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512310812246912600)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512311035322912600)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512310812246912600)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512311519229912601)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512310812246912600)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512311892387912601)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512310812246912600)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512312276690912601)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512310812246912600)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512312669311912602)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512307807558912598)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(3312323960211796244)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512313023374912602)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512313306523912602)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512313549422912602)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512313921571912602)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512314156929912603)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512314518768912603)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512314156929912603)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512314863548912603)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512314156929912603)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512315319673912604)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512315530937912604)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512315319673912604)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512315969328912604)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512315319673912604)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512316352001912605)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512315319673912604)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512316824611912605)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512318309077912606)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512316824611912605)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512318654943912607)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512316824611912605)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512317089395912605)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512316824611912605)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512317441787912605)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512316824611912605)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512317887969912606)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512316824611912605)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512319102238912607)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512319379094912607)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512319102238912607)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512319814852912607)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3312527567380942873)
,p_plugin_id=>wwv_flow_imp.id(1512306184076912593)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
