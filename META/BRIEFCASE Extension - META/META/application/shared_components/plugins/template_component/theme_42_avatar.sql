...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1512280665449912323)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512280997640912406)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512281271908912417)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512280997640912406)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512281639827912425)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512280997640912406)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512282074855912426)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512280997640912406)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512282453354912436)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1512280997640912406)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512282745409912438)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512283125966912438)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512283403961912438)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512283715503912438)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512283986607912439)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512283715503912438)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512284395517912439)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512283715503912438)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512284768340912439)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512283715503912438)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512285152243912440)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512283715503912438)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512285597115912440)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512285853760912440)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512285597115912440)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512286293984912441)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512285597115912440)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512286634671912441)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512285597115912440)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512287126237912441)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512285597115912440)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512287467240912441)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512285597115912440)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512287896493912442)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512285597115912440)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1512288324006912442)
,p_plugin_attribute_id=>wwv_flow_imp.id(1512285597115912440)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1512288714785912442)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(3312331507481026077)
,p_plugin_id=>wwv_flow_imp.id(1512280665449912323)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
