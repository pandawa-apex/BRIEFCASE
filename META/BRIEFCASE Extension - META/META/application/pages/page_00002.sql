...
,p_last_upd_yyyymmddhh24miss=>'20250714110201'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512415202897994860)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512415835705994885)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512417776388994904)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512418199659994905)
,p_plug_name=>'Upload a File'
,p_parent_plug_id=>wwv_flow_imp.id(1512417776388994904)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512420253467994943)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1512423206702994962)
,p_name=>'Preview'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512423510229995040)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512423917069995043)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512424319996995043)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512424654981995044)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512425060965995044)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512425493995995044)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512425889008995045)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512426283669995045)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512426665502995045)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512427054121995045)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1512427478541995046)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512431666060000171)
,p_plug_name=>'View'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1512431731863000172)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1512431871739000173)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1512431963931000174)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1512432087136000175)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1512432305030000177)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1512432166795000176)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1512485663902159542)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1512416293790994892)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1512415835705994885)
,p_button_name=>'CLEAR'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1512416616998994893)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512418587850994911)
,p_name=>'P2_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1512418199659994905)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512418962432994914)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512420643458994945)
,p_name=>'P2_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1512420253467994943)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512421832782994958)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1512421217665994951)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1512421591499994953)
...
,p_associated_item=>wwv_flow_imp.id(1512418587850994911)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_required_patch=>wwv_flow_imp.id(1512101675756911678)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1512419333947994914)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1512419841001994921)
,p_event_id=>wwv_flow_imp.id(1512419333947994914)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1512422267039994961)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1512422734957994962)
,p_event_id=>wwv_flow_imp.id(1512422267039994961)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512417093763994894)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Load Data'
,p_attribute_01=>wwv_flow_imp.id(1512414389455992279)
,p_attribute_02=>'FILE'
,p_attribute_03=>'P2_FILE'
,p_attribute_06=>'P2_XLSX_WORKSHEET'
,p_attribute_08=>'P2_ERROR_ROW_COUNT'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1512416616998994893)
,p_internal_uid=>143015064310043324
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512432357249000178)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512432434067000179)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512417487858994904)
