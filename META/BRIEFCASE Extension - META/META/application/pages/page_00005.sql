...
,p_last_upd_yyyymmddhh24miss=>'20260110173503'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1369531054614635110)
...
'  AND  base.location = :P5_LOCATION_TRX',
...
'    SUM(',
'        CASE WHEN base.category = ''Revenue'' then base.NET_SALES',
'        when base.category = ''COGS'' then base.HPP',
'        END',
'        ) AS actual_amount',
'FROM APX_BF_REVENUE_COGS_AMT_V base',
'WHERE (TRIM(UPPER(base.product)) = TRIM(UPPER(:P5_REV_PRODUCT)) OR NVL(:P5_REV_PRODUCT, '''') = '''')',
'  AND (TRIM(UPPER(base.company)) = TRIM(UPPER(:P5_COMPANY_TRX)) OR NVL(:P5_COMPANY_TRX, '''') = '''')',
'  AND (TRIM(UPPER(base.BULAN)) = TRIM(UPPER(:P5_PERIOD_TRX)) OR NVL(:P5_PERIOD_TRX, '''') = '''')',
'  AND (TRIM(UPPER(base.CATEGORY)) = TRIM(UPPER(:P5_REV_CATEGORY)) OR NVL(:P5_REV_CATEGORY, '''') = '''')',
'GROUP BY base.product || '' - '' || base.product_desc, base.CATEGORY, base.ITEM_CODE',
''))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P5_ACTUAL_TRX,P5_PERIOD_TRX,P5_COMPANY_TRX,P5_REV_COA,P5_REV_PRODUCT,P5_ACTIVITY_TRX,P5_LOCATION_TRX'
...
,p_prn_page_header=>'Report Actual'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1369531157877635111)
...
,p_internal_uid=>593464639639707333
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1369531317825635112)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1369531356705635113)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1369531503908635114)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1373895761673576327)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1373761370256575051)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'5976949'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1369531868303635118)
,p_plug_name=>'No Data'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1512145932922912008)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1373752996901536897)
...
'       AND base.period     = :P5_PERIOD_TRX',
'       AND base.location   = :P5_LOCATION_TRX --added by Yeremia 20261001',
'       AND trim(base.company) = trim(:P5_COMPANY_TRX)',
'       AND EXISTS (',
'           SELECT 1',
'             FROM params p',
...
,p_prn_height=>8.5
,p_prn_orientation=>'HORIZONTAL'
,p_prn_page_header=>'Report Commitment'
,p_prn_page_header_font_color=>'#000000'
,p_prn_page_header_font_family=>'Helvetica'
,p_prn_page_header_font_weight=>'normal'
,p_prn_page_header_font_size=>'12'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1373753061023536897)
,p_name=>'Transactions'
...
,p_enable_mail_download=>'Y'
,p_owner=>'YEREMIA.NDAUMANU@LIMAMAIL.NET'
,p_internal_uid=>597686542785609119
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1373753507939536911)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1373753895266536914)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1373754284207536915)
,p_db_column_name=>'TYPE'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1373754620494536915)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1373895829298576328)
,p_db_column_name=>'SOURCE'
,p_display_order=>14
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1373760898899575040)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'5976944'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1377775383151956481)
,p_plug_name=>'Report Commitment'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1512195688984912037)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1377775436767956482)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_enable_mail_download=>'Y'
,p_owner=>'YEREMIA.NDAUMANU@LIMAMAIL.NET'
,p_internal_uid=>601708918530028704
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377775562417956483)
,p_db_column_name=>'PR_NO'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Pr No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377775693531956484)
,p_db_column_name=>'TRANSACTION_NUMBER'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Transaction Number'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377775780316956485)
,p_db_column_name=>'TYPE'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377775904647956486)
,p_db_column_name=>'COMMITMENT'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Commitment'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377775947829956487)
,p_db_column_name=>'SOURCE'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Source'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1377776037798956488)
,p_plug_name=>'Report Actual'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1512195688984912037)
...
'',
'UNION ALL',
'SELECT base.invoice_number AS transaction, ',
'       ''INVOICE NUMBER'' AS type,',
'       base.source as source, ',
'       SUM(base.actual_amount) AS actual_amount',
'FROM   apx_bf_comm_act_amt base',
'JOIN   params p ',
...
'      AND UPPER(TRIM(base.invoice_number)) = UPPER(TRIM(p.val))',
'WHERE  base.activity = :P5_ACTIVITY_TRX',
'GROUP BY base.invoice_number, base.source',
'',
'UNION ALL',
'SELECT base.journal_batch || '' | '' || base.journal_name AS transaction, ',
'       ''JOURNAL'' AS type, ',
...
'',
'UNION ALL',
'SELECT base.INV_SOURCE_NAME AS transaction, ',
'       ''INVENTORY NUMBER'' AS type, ',
'       base.source as source,',
'       SUM(base.actual_amount) AS actual_amount',
'FROM   apx_bf_comm_act_amt base',
'JOIN   params p ',
...
'      AND TRIM(base.inv_trx_number) = TRIM(p.val)',
'WHERE  base.activity = :P5_ACTIVITY_TRX',
'GROUP BY base.INV_SOURCE_NAME, base.source',
'',
'UNION ALL',
'SELECT base.ar_trx_number AS transaction, ',
'       ''RECEIVABLES NUMBER'' AS type, ',
...
'JOIN   params p ',
'       ON p.fld = ''AR_MISC_RECEIPT'' ',
'      AND TRIM(base.ar_misc_receipt) = TRIM(p.val)',
'WHERE  base.activity = :P5_ACTIVITY_TRX',
'GROUP BY base.ar_misc_receipt, base.source',
'',
'UNION ALL',
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1377776198547956489)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_enable_mail_download=>'Y'
,p_owner=>'YEREMIA.NDAUMANU@LIMAMAIL.NET'
,p_internal_uid=>601709680310028711
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377776231004956490)
,p_db_column_name=>'TRANSACTION'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Transaction'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377776375096956491)
,p_db_column_name=>'TYPE'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377776477126956492)
,p_db_column_name=>'ACTUAL_AMOUNT'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Actual Amount'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1377776526146956493)
,p_db_column_name=>'SOURCE'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Source'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(778311549135848702)
,p_name=>'P5_LOCATION_TRX'
,p_item_sequence=>30
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1369531571475635115)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1369531653279635116)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1369531731846635117)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1377775185750956479)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1377775269574956480)
,p_name=>'P5_COMPANY_TRX'
,p_item_sequence=>50
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1377777392964956501)
,p_name=>'P5_REV_COA'
,p_item_sequence=>60
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1377777446741956502)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1377777591182956503)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1377777708032956504)
