...
,p_last_upd_yyyymmddhh24miss=>'20260102103150'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512599163769077297)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512621951501911408)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1512623632177911452)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1512599163769077297)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1512624670515911456)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1512599163769077297)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1512625061372911456)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1512624263624911456)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1512599163769077297)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1369530288873635102)
,p_name=>'P10_COMPANY'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(1512621951501911408)
,p_item_source_plug_id=>wwv_flow_imp.id(1512621951501911408)
,p_prompt=>'Company'
,p_source=>'COMPANY'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'SELECT DISTINCT COMPANY_CODE FROM APX_BF_ENTITY_PROFILES;'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512598517675077290)
,p_name=>'P10_USERNAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(1512621951501911408)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512622306005911408)
,p_name=>'P10_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512622630704911444)
,p_name=>'P10_TITLE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1512621951501911408)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1512598543067077291)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1512623632177911452)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1512598662186077292)
,p_event_id=>wwv_flow_imp.id(1512598543067077291)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512626237759911467)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(1512621951501911408)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512598732302077293)
...
'    INSERT INTO apx_bf_access_rights (title, COMPANY)',
'    VALUES (:P10_TITLE, :P10_COMPANY)',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1512625061372911456)
,p_internal_uid=>143196702848125723
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512598954401077295)
...
'    WHERE id = :P10_ID;',
'',
'    -- 2. Hapus semua user yang terkait dengan akses ini',
'    DELETE FROM apx_bf_user_access',
'    WHERE apx_access_rights_id = :P10_ID;',
'',
'    -- 3. Split username multi-select berdasarkan delimiter `:`',
'    v_usernames := apex_string.split(:P10_USERNAME, '':'');',
'',
'    -- 4. Insert kembali semua username yang dipilih',
'    FOR i IN 1 .. v_usernames.COUNT LOOP',
'        INSERT INTO apx_bf_user_access (username, apx_access_rights_id)',
'        VALUES (v_usernames(i), :P10_ID);',
'    END LOOP;',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1512624670515911456)
,p_internal_uid=>143196924947125725
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512599106843077296)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1512624263624911456)
,p_internal_uid=>143197077389125726
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512598897079077294)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1512625869514911466)
,p_process_sequence=>10
