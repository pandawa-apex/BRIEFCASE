...
'$(''#P32_DEPARTMENT_VALUE'').attr(''title'', $(''#P32_DEPARTMENT_VALUE'').text());',
''))
...
,p_last_upd_yyyymmddhh24miss=>'20260110173302'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1371751261137661994)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512553425365479094)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512554759831479108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512554906554479109)
,p_plug_name=>'Sum Original Amount'
,p_parent_plug_id=>wwv_flow_imp.id(1512554759831479108)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader js-removeLandmark:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(1512205487279912040)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512555154281479112)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1382001852060667182)
,p_plug_name=>'Region Display Selector'
,p_region_name=>'region_display_selector'
,p_parent_plug_id=>wwv_flow_imp.id(1512555154281479112)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1382001986789667183)
,p_plug_name=>'Summary'
,p_parent_plug_id=>wwv_flow_imp.id(1512555154281479112)
...
,p_web_src_module_id=>wwv_flow_imp.id(1377713632695458015)
...
'           REST.REJECT_NOTES,',
'           REST.UPDATED_DATE,',
'           NVL(CA.TOTAL_ACTUAL_AMOUNT, 0) + NVL (',
'               CASE WHEN REV.CATEGORY = ''Revenue'' THEN REV.NET_SALES',
'               WHEN REV.CATEGORY = ''COGS'' THEN REV.HPP',
'               END, 0) AS ACTUAL_AMOUNT,',
'           NVL((REST.FINAL_AMOUNT - NVL(CA.TOTAL_COMMITMENT, 0) - NVL(CA.TOTAL_ACTUAL_AMOUNT, 0) - NVL(',
'               CASE WHEN REV.CATEGORY = ''Revenue'' THEN REV.NET_SALES',
'               WHEN REV.CATEGORY = ''COGS'' THEN REV.HPP',
'               END, 0)), 0) AS FUND_AVAILABLE,',
...
'         AND CA.COMPANY = :P7_COMPANY_VALUE',
'         AND TRIM(CA.LOCATION) = TRIM(REGEXP_SUBSTR(REST.LOCATION, ''[^-]+'', 1, 1))',
'      LEFT JOIN APX_BF_REVENUE_COGS_AMT_V REV',
'        ON  REGEXP_SUBSTR(REST.PRODUCT, ''^\d+'') = REV.PRODUCT',
'            AND REST.BUDGET_CATEGORY = REV.CATEGORY',
'            AND TRIM(REV.COMPANY) = :P7_COMPANY_VALUE',
'            AND TRIM(REV.BULAN) = TRIM(REST.PERIOD)',
...
'      LEFT JOIN APPS.XTD_BF_HR_LOCATIONS_V xbl',
'           on xbl.company = :P7_COMPANY_VALUE',
'           and xbl.account = ca.location',
'      WHERE 1=1',
...
,p_ajax_items_to_submit=>'P7_HEADER_ID,P7_YEAR_VALUE,P7_COMPANY_VALUE'
,p_prn_units=>'INCHES'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002128236667185)
,p_name=>'LINK_KEY'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002270422667186)
,p_name=>'LINE_NUMBER'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002397665667187)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002446104667188)
,p_name=>'HEADER_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002542482667189)
,p_name=>'VERSION_NO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002635268667190)
,p_name=>'COMPANY_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002803415667191)
,p_name=>'COST_CENTER'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002914386667192)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382002927250667193)
,p_name=>'ACTIVITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382003059996667194)
,p_name=>'COA'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382003148027667195)
,p_name=>'PRICE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382003262785667196)
,p_name=>'LOCATION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382003976132667203)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004034899667204)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004126362667205)
,p_name=>'TRX_ACTIVITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004231932667206)
,p_name=>'REV_COA'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004338883667207)
,p_name=>'REV_PRODUCT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004490047667208)
,p_name=>'REJECT_NOTES'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004544758667209)
,p_name=>'LINE_SOURCE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004668632667210)
,p_name=>'CREATED_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004788836667211)
,p_name=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004875113667212)
,p_name=>'UPDATED_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382004944372667213)
,p_name=>'UPDATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382005079168667214)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382005170079667215)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382005228297667216)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382005372245667217)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1382005449736667218)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1382002042258667184)
,p_internal_uid=>605935524020739406
,p_is_editable=>false
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1382365557841282520)
,p_interactive_grid_id=>wwv_flow_imp.id(1382002042258667184)
,p_static_id=>'6062991'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1382365727402282522)
,p_report_id=>wwv_flow_imp.id(1382365557841282520)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382366308509282535)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1382002128236667185)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382367049240282545)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(1382002270422667186)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382368010913282549)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1382002397665667187)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382368857347282552)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1382002446104667188)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382369723076282556)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1382002542482667189)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382370680983282559)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1382002635268667190)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382371575455282563)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1382002803415667191)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>271
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382372442464282567)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1382002914386667192)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>137
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382373366524282570)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1382002927250667193)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>242
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382374285849282574)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1382003059996667194)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>354
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382375170313282577)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1382003148027667195)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382376035399282580)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(1382003262785667196)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>190
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382382333440282607)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(1382003976132667203)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382383303969282610)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(1382004034899667204)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382384149218282614)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(1382004126362667205)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382385092321282618)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(1382004231932667206)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382385956239282621)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(1382004338883667207)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382386891773282625)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(1382004490047667208)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382387817246282629)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(1382004544758667209)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382388555479282635)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(1382004668632667210)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382389421938282638)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(1382004788836667211)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382390321072282642)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(1382004875113667212)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382391295821282646)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(1382004944372667213)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382395335976380554)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>26
,p_column_id=>wwv_flow_imp.id(1382005079168667214)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>156
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382396256741380557)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>25
,p_column_id=>wwv_flow_imp.id(1382005170079667215)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>159
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382397121119380561)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>27
,p_column_id=>wwv_flow_imp.id(1382005228297667216)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>170
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382398113288380566)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>28
,p_column_id=>wwv_flow_imp.id(1382005372245667217)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>167
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1382399004710380569)
,p_view_id=>wwv_flow_imp.id(1382365727402282522)
,p_display_seq=>24
,p_column_id=>wwv_flow_imp.id(1382005449736667218)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>181
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512598048901077286)
,p_plug_name=>'Detail'
,p_parent_plug_id=>wwv_flow_imp.id(1512555154281479112)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1512195688984912037)
...
'FROM (',
'SELECT ',
'       NVL(TO_CHAR(REST.ID), ''REST_'' || ROWNUM) AS LINK_KEY, -- Use ID if exists, otherwise generate surrogate for linking',
'       REST.ID,',
'       REST.COA,',
'       REST.PRICE,',
'       REST.PERIOD,',
...
'       REV.CATEGORY AS REV_COA,',
'       REV.PRODUCT AS REV_PRODUCT,',
'       TRIM(CA.LOCATION) as TRX_LOCATION ',
'  FROM #APEX$SOURCE_DATA# REST',
'  JOIN APX_BF_BUDGET_MONITOR_HDR H',
'         on H.ID = :P7_HEADER_ID',
'  LEFT JOIN APX_BF_COMM_ACT_SUM_V CA',
...
'',
' SELECT ',
'       ''UNB_'' || ROWNUM AS LINK_KEY, -- Generate a unique link key for unbudgeted rows',
'       NULL ID,',
'       NULL COA,',
'       NULL PRICE,',
'       CA.PERIOD AS PERIOD,',
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(778311652419848703)
,p_name=>'TRX_LOCATION'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TRX_LOCATION'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
,p_is_query_only=>false
,p_item_type=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369406914055043880)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369407157978043883)
,p_name=>'VERSION_NO'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'VERSION_NO'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369407712078043888)
,p_name=>'COA'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'COA'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369408127588043893)
,p_name=>'REJECT_NOTES'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'REJECT_NOTES'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369409728067043909)
,p_name=>'CREATED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'CREATED_DATE'
,p_data_type=>'TIMESTAMP_TZ'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369409900486043910)
,p_name=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'CREATED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369409967266043911)
,p_name=>'UPDATED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'UPDATED_DATE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369410032951043912)
,p_name=>'UPDATED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'UPDATED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1369410402062043915)
,p_name=>'LINE_SOURCE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LINE_SOURCE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1371751772087661999)
,p_name=>'COMPANY_NAME'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'COMPANY_NAME'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377657974811427288)
,p_name=>'PRICE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'PRICE'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658089302427289)
,p_name=>'PERIOD'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658248291427291)
,p_name=>'ACTIVITY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ACTIVITY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658343289427292)
,p_name=>'LOCATION'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LOCATION'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658475942427293)
,p_name=>'HEADER_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'HEADER_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658571320427294)
,p_name=>'COMMITMENT'
,p_source_type=>'DB_COLUMN'
...
,p_is_required=>false
,p_max_length=>4000
,p_link_target=>'f?p=&APP_ID.:5:&SESSION.::&DEBUG.::P5_ACTIVITY_TRX,P5_ACTUAL_TRX,P5_COMMITMENT_TRX,P5_PERIOD_TRX,P5_COMPANY_TRX,P5_REV_COA:&TRX_ACTIVITY.,,&TRX_COMMITMENT_NUMBER.,&PERIOD.,&P7_COMPANY_VALUE.,'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658634661427295)
,p_name=>'COST_CENTER'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'COST_CENTER'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658740971427296)
,p_name=>'LINE_NUMBER'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LINE_NUMBER'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658833941427297)
,p_name=>'FINAL_AMOUNT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377658918928427298)
...
,p_is_required=>false
,p_max_length=>4000
,p_link_target=>'f?p=&APP_ID.:5:&SESSION.::&DEBUG.::P5_ACTIVITY_TRX,P5_COMMITMENT_TRX,P5_ACTUAL_TRX,P5_PERIOD_TRX,P5_COMPANY_TRX,P5_REV_COA,P5_REV_PRODUCT,P5_ACTIVITY_REV,P5_REV_CATEGORY,P5_LOCATION_TRX:\&TRX_ACTIVITY.\,,\&TRX_ACTUAL_NUMBER.\,\&PERIOD.\,\&P7_COMPANY_'
||'VALUE.\,\&REV_COA.\,\&REV_PRODUCT.\,\&ACTIVITY.\,\&BUDGET_CATEGORY.\,\&TRX_LOCATION.\'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377659093609427299)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377659191074427300)
,p_name=>'BUDGET_CATEGORY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'BUDGET_CATEGORY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377659230682427301)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377659500116427303)
,p_name=>'LINK_KEY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LINK_KEY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377659593104427304)
,p_name=>'TRX_COMMITMENT_NUMBER'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TRX_COMMITMENT_NUMBER'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377659624230427305)
,p_name=>'TRX_ACTUAL_NUMBER'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TRX_ACTUAL_NUMBER'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377659739554427306)
,p_name=>'TRX_ACTIVITY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TRX_ACTIVITY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377777141762956499)
,p_name=>'REV_COA'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'REV_COA'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1377777289214956500)
,p_name=>'REV_PRODUCT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'REV_PRODUCT'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1369406795422043879)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1369413126188081141)
,p_interactive_grid_id=>wwv_flow_imp.id(1369406795422043879)
,p_static_id=>'5933467'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1369413321163081141)
,p_report_id=>wwv_flow_imp.id(1369413126188081141)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(783574924767308656)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>30
,p_column_id=>wwv_flow_imp.id(778311652419848703)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369413854087081150)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1369406914055043880)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369416518356081160)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1369407157978043883)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369421073936081173)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1369407712078043888)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>353
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369425584758081189)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1369408127588043893)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369439906366081236)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1369409728067043909)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369440720761081239)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1369409900486043910)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369441673826081243)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(1369409967266043911)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369442549256081246)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(1369410032951043912)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1369445302779081254)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1369410402062043915)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1373678536252497485)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(1371751772087661999)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377716175753470730)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(1377657974811427288)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377716955444470734)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(1377658089302427289)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>97.4479740234375
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377717871381470737)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1377658248291427291)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>242.1146
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377718814669470740)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1377658343289427292)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>204.115
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377719676343470743)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(1377658475942427293)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377720594367470746)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(1377658571320427294)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>119.1146
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377721438600470750)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(1377658634661427295)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>271.1146
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377722337174470753)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(1377658740971427296)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377723252126470761)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(1377658833941427297)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>129.1146
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377724186517470764)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(1377658918928427298)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>124.1146
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377725041985470768)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(1377659093609427299)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>129.1146
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377725960592470771)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1377659191074427300)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>137.1146
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377726831562470774)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(1377659230682427301)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>136.1146
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377727805789470777)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>24
,p_column_id=>wwv_flow_imp.id(1377659500116427303)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377728682940470780)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>26
,p_column_id=>wwv_flow_imp.id(1377659593104427304)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>80
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377729604700470784)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>27
,p_column_id=>wwv_flow_imp.id(1377659624230427305)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>60
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377730469099470787)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>25
,p_column_id=>wwv_flow_imp.id(1377659739554427306)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>277.172
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377930177749740752)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>28
,p_column_id=>wwv_flow_imp.id(1377777141762956499)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1377931162408740756)
,p_view_id=>wwv_flow_imp.id(1369413321163081141)
,p_display_seq=>29
,p_column_id=>wwv_flow_imp.id(1377777289214956500)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512595856428857515)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1377777811506956505)
,p_button_sequence=>130
,p_button_name=>'DIAGNOSTIC_IT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(1512278723815912142)
,p_button_image_alt=>'Diagnostic IT'
,p_grid_new_row=>'Y'
,p_security_scheme=>wwv_flow_imp.id(1512395074248912985)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1371751459770661996)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1371751261137661994)
,p_button_name=>'Back'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1377776775362956495)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1512595856428857515)
...
,p_button_position=>'NEXT'
,p_button_condition=>'P7_LAST_SYNC_TIME'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_button_css_classes=>'apex_disabled'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1377776625556956494)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1377776894338956496)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512552744609479088)
,p_name=>'P7_HEADER_ID'
,p_item_sequence=>10
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512552881792479089)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553018656479090)
,p_name=>'P7_LEDGER_ID'
,p_item_sequence=>60
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553055001479091)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553142711479092)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553308482479093)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553518890479095)
,p_name=>'P7_BATCH_NUMBER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1512553425365479094)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553589016479096)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553697374479097)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553739187479098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553886849479099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512553958848479100)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512554036385479101)
,p_name=>'P7_YEAR'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(1512553425365479094)
,p_prompt=>'Year'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512554194170479102)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512554323731479103)
,p_name=>'P7_COMPANY'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(1512553425365479094)
,p_prompt=>'Company'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512554348758479104)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512554445460479105)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512554600581479106)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512554722001479107)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512554985814479110)
,p_name=>'P7_SUM_ORIGINAL_AMOUNT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1512554906554479109)
,p_prompt=>'Total Original Budget'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_imp.id(1512276161722912126)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512555065020479111)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1512555311698479113)
,p_name=>'P7_DELETE_SELECTED_ROWS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1512555154281479112)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1377776997464956497)
...
'        v_error_trace   := DBMS_UTILITY.FORMAT_ERROR_BACKTRACE;',
'        apex_debug.MESSAGE (''Unexpected error: %s'', SQLERRM);',
'        BEGIN',
'            INSERT INTO APX_BF_COMM_ACT_AMT_LOG_ERR (',
'                USER_NAME,',
'                DEPT_NAME,',
'                HEADER_ID,',
'                YEAR_VALUE,',
...
'        EXCEPTION',
'            WHEN OTHERS THEN',
'                NULL; -- jangan ganggu rollback utama',
'        END;',
'        RAISE;',
'END;'))
...
,p_process_when_button_id=>wwv_flow_imp.id(1377776625556956494)
,p_process_success_message=>'Refresh Done'
,p_internal_uid=>601710479227028719
);
wwv_flow_imp.component_end;
end;
/
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1371751571643661997)
,p_process_sequence=>10
...
'END;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>595685053405734219
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1377777072557956498)
...
''))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>601710554320028720
);
wwv_flow_imp.component_end;
end;
/
