...
,p_required_role=>wwv_flow_imp.id(1512395074248912985)
,p_protection_level=>'C'
,p_page_component_map=>'18'
,p_last_updated_by=>'YEREMIA.NDAUMANU@LIMAMAIL.NET'
,p_last_upd_yyyymmddhh24miss=>'20260115133201'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378506015377106791)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378506130309106793)
,p_plug_name=>'Buttons Container (User)'
,p_parent_plug_id=>wwv_flow_imp.id(1378506015377106791)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378506066873106792)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378506233078106794)
,p_plug_name=>'Buttons Container (Dept)'
,p_parent_plug_id=>wwv_flow_imp.id(1378506066873106792)
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>wwv_flow_imp.id(1512141678832912006)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512617249130708506)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1512617960608708528)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1512618039153708528)
,p_name=>'Master Hak Akses'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1512618475726708560)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1512618918053708568)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1512619270365708569)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1512629965945966418)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1378506322905106795)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1378506130309106793)
...
,p_button_redirect_url=>'f?p=&APP_ID.:21:&SESSION.::&DEBUG.::P21_HAK_AKSES,P21_USER_ROLE,P21_USER_DEPTS:USER,&P9_USER_ROLE.,&P9_USER_DEPTS.'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1378506457295106796)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1378506233078106794)
...
,p_button_image_alt=>'Upload'
,p_button_position=>'CREATE'
,p_button_redirect_url=>'f?p=&APP_ID.:21:&SESSION.::&DEBUG.::P21_HAK_AKSES,P21_USER_ROLE,P21_USER_DEPTS:DEPT,&P9_USER_ROLE.,&P9_USER_DEPTS.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'APEX_ACL.HAS_USER_ROLE (',
'                     p_application_id  => :APP_ID,',
'                     p_user_name       => :APP_USER,',
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(778311750192848704)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1512617960608708528)
,p_button_name=>'CHECK_DUPLICATE'
,p_button_action=>'REDIRECT_PAGE'
...
,p_button_image_alt=>'Check Duplicate'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:12:&SESSION.::&DEBUG.:::'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1512598387624077289)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1379294150986616689)
,p_name=>'P9_USER_ROLE'
,p_item_sequence=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1379294256115616690)
,p_name=>'P9_USER_DEPTS'
,p_item_sequence=>50
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1379294386633616691)
,p_name=>'P9_USER_COMPANIES'
,p_item_sequence=>40
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1512598137380077287)
,p_name=>'Refresh'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1512617960608708528)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosecanceldialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1512598300762077288)
,p_event_id=>wwv_flow_imp.id(1512598137380077287)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1512617960608708528)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1379294021235616688)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Get User, Companies and Depts'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    v_role_user varchar2(50) := get_user_role(:APP_ID, :APP_USER);',
'BEGIN',
'    :P9_USER_ROLE := UPPER(v_role_user);',
'',
'    IF v_role_user IS NOT NULL',
'    THEN',
'        SELECT LISTAGG(distinct(ep.COMPANY_CODE), '', '')',
'        INTO :P9_USER_COMPANIES',
...
,p_internal_uid=>603227502997688910
);
