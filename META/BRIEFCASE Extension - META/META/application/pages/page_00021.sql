...
'}',
'',
'#hak_akses_user_title::after,',
'#hak_akses_dept_title::after {',
'    content: '''';',
'    position: absolute;',
'    top: -2px;',
'    left: -2px;',
...
'}',
'',
'#hak_akses_user_title:hover::after,',
'#hak_akses_dept_title:hover::after {',
'    opacity: 0.6;',
'}',
'',
...
'',
'#hak_akses_user_title {',
'    border-left: 4px solid rgba(145, 94, 255, 0.4);',
'}',
'',
'#hak_akses_user_title::before {',
'    background: ',
'        radial-gradient(circle at 10% 20%, rgba(145, 94, 255, 0.12) 0%, transparent 50%),',
'        radial-gradient(circle at 90% 80%, rgba(0, 219, 222, 0.06) 0%, transparent 50%);',
'}',
'',
'#hak_akses_dept_title {',
...
'#download_template_button_dept_dnn:hover .t-Icon {',
'    animation: moveDown 0.8s ease-in-out infinite;',
'}',
'#download_template_button_dept_nna:hover .t-Icon {',
'    animation: moveDown 0.8s ease-in-out infinite;',
'}',
'',
...
'/* -------------------------------------------------------------------------------------------- */',
'',
'/* #download_template_button_dept_dnn {',
'    display: flex;',
'    align-items: center;',
'    justify-content: center;',
'}',
'',
'#download_template_button_dept_dnn .t-Icon {',
'    position: relative;',
'    animation: none;',
'    transition: transform 0.3s ease;',
'}',
...
,p_last_upd_yyyymmddhh24miss=>'20251110115332'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378506631373106798)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378506744865106799)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378506818931106800)
,p_plug_name=>'Upload Hak Akses'
,p_region_name=>'upload_hak_akses'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378507315136106804)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378507444338106806)
,p_plug_name=>'Buttons Container (User)'
,p_parent_plug_id=>wwv_flow_imp.id(1378507315136106804)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378507346571106805)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1378507631615106808)
,p_plug_name=>'DNN - Buttons Container (Dept)'
,p_region_name=>'buttons_container_dnn'
,p_parent_plug_id=>wwv_flow_imp.id(1378507346571106805)
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI:margin-bottom-sm'
,p_plug_template=>wwv_flow_imp.id(1512141678832912006)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1379294529779616693)
,p_plug_name=>'NNA - Buttons Container (Dept)'
,p_region_name=>'buttons_container_nna'
,p_parent_plug_id=>wwv_flow_imp.id(1378507346571106805)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1378507904645106810)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1378507444338106806)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1378508017495106811)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1378507631615106808)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1378508032967106812)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1378507444338106806)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1378508188732106813)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1378507567448106807)
...
,p_button_redirect_url=>'#APP_FILES#META - Master Hak Akses Upload User.xlsm'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
':P21_FILE IS NULL AND :P21_HAK_AKSES = ''USER'' AND',
'(',
'         APEX_ACL.HAS_USER_ROLE (',
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1378507753140106809)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1378507631615106808)
,p_button_name=>'DOWNLOAD_TEMPLATE_DEPT_DNN'
,p_button_static_id=>'download_template_button_dept_dnn'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:t-Button--simple:t-Button--iconLeft:t-Button--padBottom'
,p_button_template_id=>wwv_flow_imp.id(1512278735461912143)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Template DNN'
,p_button_position=>'PREVIOUS'
,p_button_redirect_url=>'#APP_FILES#DNN - Master Hak Akses Upload Dept.xlsm'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
':P21_FILE IS NULL AND :P21_HAK_AKSES = ''DEPT'' AND',
'(',
'         APEX_ACL.HAS_USER_ROLE (',
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1379293750921616685)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1378507631615106808)
,p_button_name=>'DOWNLOAD_TEMPLATE_DEPT_NNA'
,p_button_static_id=>'download_template_button_dept_nna'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:t-Button--simple:t-Button--iconLeft:t-Button--padBottom'
,p_button_template_id=>wwv_flow_imp.id(1512278735461912143)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Template NNA '
,p_button_position=>'PREVIOUS'
,p_button_redirect_url=>'#APP_FILES#NNA - Master Hak Akses Upload Dept.xlsm'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
':P21_FILE IS NULL AND :P21_HAK_AKSES = ''DEPT'' AND',
'(',
'         APEX_ACL.HAS_USER_ROLE (',
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1378508547476106817)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1378506523477106797)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1378507007600106801)
,p_name=>'P21_STATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1378506818931106800)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1378507054817106802)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1378507127979106803)
,p_name=>'P21_FILE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(1378506818931106800)
...
,p_attribute_13=>'Drag or Drop to Upload Files'
,p_attribute_14=>'Supported formats XLSX'
,p_attribute_15=>'5100'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1379293858162616686)
,p_name=>'P21_USER_DEPTS'
,p_item_sequence=>60
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1379293929700616687)
,p_name=>'P21_USER_ROLE'
,p_item_sequence=>40
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1379294422479616692)
,p_name=>'P21_USER_COMPANIES'
,p_item_sequence=>50
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1378508292879106814)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1378508398560106815)
,p_event_id=>wwv_flow_imp.id(1378508292879106814)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1378509272751106824)
,p_name=>'Set Null & Submit Page (Reset User)'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1378507904645106810)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1378509351236106825)
,p_event_id=>wwv_flow_imp.id(1378509272751106824)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1378509481726106826)
,p_event_id=>wwv_flow_imp.id(1378509272751106824)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1378509543971106827)
,p_name=>'Set Null & Submit Page (Reset Dept)'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1378508017495106811)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1378509647819106828)
,p_event_id=>wwv_flow_imp.id(1378509543971106827)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1379293146189616679)
,p_event_id=>wwv_flow_imp.id(1378509543971106827)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1379293372988616681)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Download File User'
...
'    WHERE filename = ''META - Master Hak Akses Upload User.xlsm'';',
'    ',
'    l_filename := ''META - Master Hak Akses Upload - '' || UPPER(:P21_HAK_AKSES) || ''.xlsm'';',
'    ',
...
,p_process_when_button_id=>wwv_flow_imp.id(1378507567448106807)
,p_required_patch=>wwv_flow_imp.id(1512101675756911678)
,p_internal_uid=>603226854750688903
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1378508688936106818)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1378508032967106812)
,p_internal_uid=>602442170698179040
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1378508818224106819)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1378508188732106813)
,p_internal_uid=>602442299986179041
);
wwv_flow_imp.component_end;
end;
/
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1378508485611106816)
...
,p_internal_uid=>602441967373179038
);
null;
wwv_flow_imp.component_end;
end;
