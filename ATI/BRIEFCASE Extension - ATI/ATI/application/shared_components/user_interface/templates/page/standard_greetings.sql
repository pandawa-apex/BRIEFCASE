...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(30890431312893301)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30890833410893279)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30891349890893277)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30891854314893277)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30892358084893276)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30892910911893275)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30893370036893275)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30893923303893274)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30894395487893273)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30894905936893273)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30895412299893272)
,p_page_template_id=>wwv_flow_imp.id(30890431312893301)
