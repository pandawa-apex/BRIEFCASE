...
wwv_flow_imp_shared.create_automation(
 p_id=>wwv_flow_imp.id(14964107397642377)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(14964401550642231)
,p_automation_id=>wwv_flow_imp.id(14964107397642377)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(14965135728627612)
,p_automation_id=>wwv_flow_imp.id(14964107397642377)
