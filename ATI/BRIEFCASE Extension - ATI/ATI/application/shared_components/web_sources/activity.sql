...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(14100980465748610)
,p_name=>'Activity'
,p_static_id=>'activity'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(14089689093748622)
...
,p_version_scn=>39517228935703
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(14101565545748602)
,p_web_src_module_id=>wwv_flow_imp.id(14100980465748610)
,p_name=>'company'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(14101171532748607)
,p_web_src_module_id=>wwv_flow_imp.id(14100980465748610)
,p_operation=>'GET'
