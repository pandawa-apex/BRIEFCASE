...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(14231710651324337)
...
,p_credential_id=>wwv_flow_imp.id(14224275040324342)
...
,p_version_scn=>39517229616799
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(14232328583324336)
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(14231867039324336)
,p_web_src_module_id=>wwv_flow_imp.id(14231710651324337)
,p_operation=>'GET'
