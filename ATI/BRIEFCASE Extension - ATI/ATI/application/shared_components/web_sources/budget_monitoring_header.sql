...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(14147586166356262)
...
,p_credential_id=>wwv_flow_imp.id(14142333556356268)
...
,p_version_scn=>39517229387902
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(14148202792356261)
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(14147766191356262)
,p_web_src_module_id=>wwv_flow_imp.id(14147586166356262)
,p_operation=>'GET'
