...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(765357715139404600)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>6213121222917
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(765656818705406046)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(765742030089671657)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(765787550140831406)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(765871886792201368)
