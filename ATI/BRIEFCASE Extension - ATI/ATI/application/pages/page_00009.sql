...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15310240566417313)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14742894233342318)
,p_plug_name=>'Buttons Container (User)'
,p_parent_plug_id=>wwv_flow_imp.id(15310240566417313)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15310248297417314)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15232375824254518)
,p_plug_name=>'Buttons Container (Dept)'
,p_parent_plug_id=>wwv_flow_imp.id(15310248297417314)
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(765872237020201384)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(765872948498201406)
...
') || ''" class="t-Button t-Button--noLabel t-Button--icon t-Button--warning t-Button--simple edit-icon" title="Edit Hak Akses User">',
'    <span aria-hidden="true" class="t-Icon fa fa-pencil"></span>',
'</a>',
'&nbsp;',
'<a href="'' || apex_util.prepare_url(',
'    ''f?p=&APP_ID.:11:&APP_SESSION.:::11:P11_SET_APX_ACCESS_RIGHTS_ID:'' || ID',
') || ''" class="t-Button t-Button--noLabel t-Button--icon t-Button--success t-Button--simple add-icon" title="Edit Hak Akses Department">',
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(765873027043201406)
,p_name=>'Master Hak Akses'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(765873463616201438)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(765873905943201446)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(765874258255201447)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(765884953835459296)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14743282123342322)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(14742894233342318)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15233022369254524)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(15232375824254518)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(765853375513570167)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(765872948498201406)
,p_button_name=>'Add'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(765853125269570165)
,p_name=>'Refresh'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(765872948498201406)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosecanceldialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(765853288651570166)
,p_event_id=>wwv_flow_imp.id(765853125269570165)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(765872948498201406)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15229857656254493)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Upload Master Hak Akses'
...
'            ELSE',
'                APEX_ERROR.ADD_ERROR(',
'                    p_message => ''Error pada baris '' || l_row_num || '': Kombinasi USERNAME "'' || r.username || ''" dan TITLE "'' || r.title || ''" sudah ada'',',
'                    p_display_location => APEX_ERROR.C_INLINE_IN_NOTIFICATION',
'                );',
'                l_error_count := l_error_count + 1;',
'                CONTINUE;',
...
'        :P9_STATUS := ''SUCCESS'';',
'        :P9_LOADED_ROW_COUNT := l_row_num;',
'        APEX_ERROR.ADD_ERROR(',
'            p_message => ''File berhasil diupload. '' || l_row_num || '' baris diproses.'',',
'            p_display_location => APEX_ERROR.C_INLINE_IN_NOTIFICATION',
'            -- ,p_message_type => ''SUCCESS''',
'        );',
'    ELSE',
'        :P9_STATUS := ''FAILED'';',
'        :P9_LOADED_ROW_COUNT := 0;',
'        APEX_ERROR.ADD_ERROR(',
'            p_message => ''Upload gagal. '' || l_error_count || '' error ditemukan.'',',
'            p_display_location => APEX_ERROR.C_INLINE_IN_NOTIFICATION',
'        );',
'    END IF;',
'',
...
,p_internal_uid=>3325014282668702
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15230524572254499)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Upload Master Hak Akses (edited)'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    v_access_rights_id    NUMBER;',
'    v_user_access_id      NUMBER;',
...
'        BEGIN',
'            ',
'            l_combination_key := UPPER(r.title) || ''|'' || UPPER(r.username) || ''|'' || UPPER(r.dept_name);',
'            IF l_combination_list.EXISTS(l_combination_key) THEN',
'                APEX_ERROR.ADD_ERROR(',
'                    p_message => ''Error pada baris '' || l_row_num || '': Kombinasi TITLE "'' || r.title || ''", USERNAME "'' || r.username || ''", dan DEPT_NAME "'' || r.dept_name || ''" duplikat dalam file yang sama'',',
'                    p_display_location => APEX_ERROR.C_INLINE_IN_NOTIFICATION',
'                );',
'                l_error_count := l_error_count + 1;',
'                CONTINUE;',
...
'    IF l_error_count = 0 THEN',
'        :P9_STATUS := ''SUCCESS'';',
'        :P9_LOADED_ROW_COUNT := l_success_count;',
'        ',
'        apex_application.g_print_success_message := ''File berhasil diupload. '' || l_success_count || '' baris data berhasil diproses.'';',
'    ELSE',
'        :P9_STATUS := ''FAILED'';',
'        :P9_LOADED_ROW_COUNT := l_success_count;',
'        ',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_required_patch=>wwv_flow_imp.id(765356663646404556)
,p_internal_uid=>3325681198668708
);
