...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16773018357209495)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16774030444209505)
,p_plug_name=>'reCAPTCHA'
,p_parent_plug_id=>wwv_flow_imp.id(16773018357209495)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16807753208589297)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16774478270209510)
...
,p_button_redirect_url=>'f?p=&APP_ID.:9999:&SESSION.::&DEBUG.:9999,8890::'
,p_grid_new_row=>'Y'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16774353316209509)
,p_button_sequence=>140
,p_button_plug_id=>wwv_flow_imp.id(16773018357209495)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(16775198589209517)
,p_branch_name=>'Go Back to Login Page 9999'
,p_branch_action=>'f?p=&APP_ID.:9999:&SESSION.::&DEBUG.:RP,9999,8890::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16773099614209496)
,p_name=>'P8890_RESET_LINK_SENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16773018357209495)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16773165441209497)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16773249808209498)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16773364609209499)
,p_name=>'P8890_LINK'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(16773018357209495)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16773602233209501)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16773702357209502)
,p_name=>'P8890_EMAIL'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(16773018357209495)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16773816280209503)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16773901541209504)
,p_name=>'P8890_ROLE'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(16773018357209495)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16774078433209506)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16774217279209507)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16774296739209508)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(16774817613209513)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16774564189209511)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16774669506209512)
,p_event_id=>wwv_flow_imp.id(16774564189209511)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16807584170589295)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16807730671589296)
,p_event_id=>wwv_flow_imp.id(16807584170589295)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16774964484209515)
...
,p_internal_uid=>4870121110623724
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16775090575209516)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(16774353316209509)
...
,p_internal_uid=>4870247201623725
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16772913104209494)
,p_process_sequence=>10
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>4868069730623703
);
