...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(765670190787487738)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(765670823595487763)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(765672764278487782)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(765673187549487783)
,p_plug_name=>'Upload a File'
,p_parent_plug_id=>wwv_flow_imp.id(765672764278487782)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(765675241357487821)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(765678194592487840)
,p_name=>'Preview'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765678498119487918)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765678904959487921)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765679307886487921)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765679642871487922)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765680048855487922)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765680481885487922)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765680876898487923)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765681271559487923)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765681653392487923)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765682042011487923)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(765682466431487924)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(765686653949493049)
,p_plug_name=>'View'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(765686719752493050)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(765686859628493051)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(765686951820493052)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(765687075025493053)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(765687292919493055)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(765687154684493054)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(765740651791652420)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(765671281680487770)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(765670823595487763)
,p_button_name=>'CLEAR'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(765671604888487771)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(765673575740487789)
,p_name=>'P2_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(765673187549487783)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(765673950322487792)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(765675631348487823)
,p_name=>'P2_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(765675241357487821)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(765676820672487836)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(765676205555487829)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(765676579389487831)
...
,p_associated_item=>wwv_flow_imp.id(765673575740487789)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_required_patch=>wwv_flow_imp.id(765356663646404556)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(765674321837487792)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(765674828891487799)
,p_event_id=>wwv_flow_imp.id(765674321837487792)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(765677254929487839)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(765677722847487840)
,p_event_id=>wwv_flow_imp.id(765677254929487839)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(765672081653487772)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Load Data'
,p_attribute_01=>wwv_flow_imp.id(765669377345485157)
,p_attribute_02=>'FILE'
,p_attribute_03=>'P2_FILE'
,p_attribute_06=>'P2_XLSX_WORKSHEET'
,p_attribute_08=>'P2_ERROR_ROW_COUNT'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(765671604888487771)
,p_internal_uid=>143015064310043324
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(765687345138493056)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(765687421956493057)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(765672475748487782)
