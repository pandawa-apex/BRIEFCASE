...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(13830002129689501)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(13830167150689502)
...
,p_owner=>'YEREMIA'
,p_internal_uid=>13830167150689502
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13830251304689503)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13830397051689504)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13830431513689505)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13830507329689506)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13830638608689507)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(13840369042699268)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'138404'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(13830734508689508)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(13830824381689509)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_enable_mail_download=>'Y'
,p_owner=>'YEREMIA'
,p_internal_uid=>13830824381689509
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13830918961689510)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13831053576689511)
,p_db_column_name=>'TYPE'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13831148211689512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(13831212847689513)
,p_db_column_name=>'SOURCE'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Source'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(13841112792704866)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'138412'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14252145223571921)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(14252282626571922)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_enable_mail_download=>'Y'
,p_owner=>'YEREMIA'
,p_internal_uid=>2347439252986131
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(14252363612571923)
,p_db_column_name=>'PR_NO'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Pr No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(14252483548571924)
,p_db_column_name=>'TRANSACTION_NUMBER'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Transaction Number'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(14252609573571925)
,p_db_column_name=>'TYPE'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(14252725412571926)
,p_db_column_name=>'COMMITMENT'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Commitment'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(14252831176571927)
,p_db_column_name=>'SOURCE'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Source'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22390419538946696)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(22390864487946700)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_enable_mail_download=>'Y'
,p_owner=>'MANUEL'
,p_internal_uid=>8509981591677213
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22391091858946703)
,p_db_column_name=>'PR_NO'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Pr No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22391266779946704)
,p_db_column_name=>'TRANSACTION_NUMBER'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Transaction Number'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22391299194946705)
,p_db_column_name=>'TYPE'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22391480347946706)
,p_db_column_name=>'COMMITMENT'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Commitment'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(23881436429453092)
,p_db_column_name=>'SOURCE'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Source'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(24415786022088093)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'105350'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PR_NO:TRANSACTION_NUMBER:TYPE:COMMITMENT'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22390954452946701)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(22391071399946702)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_enable_mail_download=>'Y'
,p_owner=>'MANUEL'
,p_internal_uid=>8510188503677215
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22391493006946707)
,p_db_column_name=>'TRANSACTION'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Transaction'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22391582967946708)
,p_db_column_name=>'TYPE'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22391694409946709)
,p_db_column_name=>'ACTUAL_AMOUNT'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Actual Amount'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(23881375387453091)
,p_db_column_name=>'SOURCE'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Source'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(24399299686364020)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'105185'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'SOURCE:TYPE:TRANSACTION:ACTUAL_AMOUNT:'
,p_sum_columns_on_break=>'ACTUAL_AMOUNT'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22391822388946710)
,p_plug_name=>'No Data'
,p_title=>'No Data'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14251583776571915)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14253466487571934)
,p_name=>'P5_REV_COA'
,p_item_sequence=>40
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14253638973571935)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14253691238571936)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14253760262571937)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22390526598946697)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22390618305946698)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22390700168946699)
