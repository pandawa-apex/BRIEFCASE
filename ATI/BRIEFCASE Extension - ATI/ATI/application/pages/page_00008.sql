...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(30794037309194315)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(622702670653580137)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(774876920466939800)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(622666052046536800)
,p_plug_name=>'View MA Briefcase'
,p_region_name=>'view_budget_marketing'
,p_parent_plug_id=>wwv_flow_imp.id(774876920466939800)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(29392771819665703)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29392870332665704)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29392973564665705)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29393087462665706)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29393182649665707)
,p_db_column_name=>'BATCH_NUM'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Batch No.'
,p_column_type=>'STRING'
,p_static_id=>'batch_num_col'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29393276798665708)
...
,p_static_id=>'version_col'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29393361921665709)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29393474307665710)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29393526286665711)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29393651117665712)
,p_db_column_name=>'TASK'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Task'
,p_column_type=>'STRING'
,p_static_id=>'task_col'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22389957820946691)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(22389988988946692)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29393862642665714)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29394016464665715)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29394045827665716)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29394159557665717)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29394293398665718)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29394399907665719)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29394682815665722)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29394436397665720)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(29394618970665721)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(29404584326623807)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'77040'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COMPANY:YEAR:COST_CENTER:BATCH_NUM:VERSION:DEPARTMENT:BUDGET_TYPE:BUDGET_CATEGORY:TASK:COA:ACTIVITY:PRODUCT:DESCRIPTION:QTY:UOM:PRICE_UOM:ORIGINAL_AMOUNT:LOCATION:PERIOD:FINAL_AMOUNT:'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(622666202649536801)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_imp.id(30794037309194315)
,p_button_name=>'Find'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(622665694472536796)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(622665730867536797)
,p_name=>'P8_YEAR_TEXT'
,p_item_sequence=>40
,p_prompt=>'Year'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(622665863542536798)
,p_name=>'P8_PERIOD'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(622665940634536799)
,p_name=>'P8_YEAR'
,p_item_sequence=>50
