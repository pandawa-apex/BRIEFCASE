...
'    apex.item(''P8889_CAPTCHA_RESPONSE'').setValue(response);',
...
'    document.getElementById(''captcha_error'').textContent = ''CAPTCHA expired. Please verify again.'';',
'    apex.item(''P8889_CAPTCHA_RESPONSE'').setValue('''');',
'}',
'',
'function onCaptchaError() {',
'    captchaResponse = null;',
'    document.getElementById(''captcha_error'').style.display = ''block'';',
'    document.getElementById(''captcha_error'').textContent = ''CAPTCHA error occurred. Please try again.'';',
'    apex.item(''P8889_CAPTCHA_RESPONSE'').setValue('''');',
'}',
'',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22490347604262813)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22490722363262816)
,p_plug_name=>'reCAPTCHA'
,p_parent_plug_id=>wwv_flow_imp.id(22490347604262813)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(22492681993262836)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(22490608357262815)
,p_button_sequence=>140
,p_button_plug_id=>wwv_flow_imp.id(22490347604262813)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(22492039317262829)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14440556650943592)
,p_name=>'P8889_PASSWORD'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(22490347604262813)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14440706326943593)
,p_name=>'P8889_ROLE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(22490347604262813)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14740481475342294)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22490527452262814)
,p_name=>'P8889_EMAIL'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(22490347604262813)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22490793450262817)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22490864080262818)
,p_name=>'P8889_LINK'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(22490347604262813)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22491022665262819)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22491110016262820)
,p_name=>'P8889_RESET_LINK_SENT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(22490347604262813)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22491254637262822)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22491386512262823)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22493142947262840)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(22491490783262824)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(22492082595262830)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(22492187963262831)
,p_event_id=>wwv_flow_imp.id(22492082595262830)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16807409981589293)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16807531991589294)
,p_event_id=>wwv_flow_imp.id(16807409981589293)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14740628961342295)
...
,p_process_when_button_id=>wwv_flow_imp.id(22490608357262815)
,p_internal_uid=>2835785587756504
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14440847196943595)
...
,p_attribute_01=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>2536003823357804
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(22491926557262828)
...
,p_process_when_button_id=>wwv_flow_imp.id(22490608357262815)
,p_required_patch=>wwv_flow_imp.id(765356663646404556)
,p_internal_uid=>10587083183677037
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14742528701342314)
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>2837685327756523
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14740668047342296)
,p_process_sequence=>30
,p_parent_process_id=>wwv_flow_imp.id(14440847196943595)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Create Password + Send Email (edited)'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    l_username VARCHAR2(100);',
...
'        WHEN NO_DATA_FOUND THEN',
'            APEX_ERROR.ADD_ERROR(',
'                p_message => ''Email tidak terdaftar dalam sistem atau status tidak aktif.'',',
'                p_display_location => APEX_ERROR.C_INLINE_IN_NOTIFICATION',
'            );',
'            RETURN;',
'    END;',
...
'            APEX_ERROR.ADD_ERROR(',
'                p_message => ''User sudah memiliki akun. Silakan gunakan fitur lupa password jika perlu reset.'',',
'                p_display_location => APEX_ERROR.C_INLINE_IN_NOTIFICATION',
'            );',
'            RETURN;',
'        END IF;',
...
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(22490608357262815)
,p_internal_uid=>2835824673756505
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14742267214342312)
...
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(22490608357262815)
,p_internal_uid=>2837423840756521
);
