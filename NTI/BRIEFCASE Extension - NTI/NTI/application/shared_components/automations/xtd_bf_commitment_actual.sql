...
wwv_flow_imp_shared.create_automation(
 p_id=>wwv_flow_imp.id(19917834633686767)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(19918167663686801)
,p_automation_id=>wwv_flow_imp.id(19917834633686767)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(19920511753781931)
,p_automation_id=>wwv_flow_imp.id(19917834633686767)
...
wwv_flow_imp_shared.create_automation_action(
 p_id=>wwv_flow_imp.id(21264495400220567)
,p_automation_id=>wwv_flow_imp.id(19917834633686767)
,p_name=>'Update Status in Table APX_BF_COMM_ACT_AMT STATUS to Sync'
,p_execution_sequence=>5
,p_action_type=>'NATIVE_PLSQL'
,p_action_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
...
,p_action_clob_language=>'PLSQL'
,p_location=>'LOCAL'
,p_error_message=>'Error: Update Status in Table APX_BF_COMM_ACT_AMT STATUS to Sync'
,p_stop_execution_on_error=>true
