...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(762783755844988689)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2562802086991872341)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2562801531979872340)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762784476574988693)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762784723655988693)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762785047166988693)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762785379326988694)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762785687818988694)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(762785047166988693)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2562802086991872341)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762785954245988694)
,p_plugin_attribute_id=>wwv_flow_imp.id(762785687818988694)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762786336520988695)
,p_plugin_attribute_id=>wwv_flow_imp.id(762785687818988694)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762786755498988695)
,p_plugin_attribute_id=>wwv_flow_imp.id(762785687818988694)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762787106848988695)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(762785687818988694)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762787488341988695)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762787775822988696)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762788098386988696)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762788384014988696)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762788607090988696)
,p_plugin_attribute_id=>wwv_flow_imp.id(762788384014988696)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762789090997988697)
,p_plugin_attribute_id=>wwv_flow_imp.id(762788384014988696)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762789464155988697)
,p_plugin_attribute_id=>wwv_flow_imp.id(762788384014988696)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762789848458988697)
,p_plugin_attribute_id=>wwv_flow_imp.id(762788384014988696)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762790241079988698)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(762785379326988694)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2562801531979872340)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762790595142988698)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762790878291988698)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762791121190988698)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762791493339988698)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762791728697988699)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762792090536988699)
,p_plugin_attribute_id=>wwv_flow_imp.id(762791728697988699)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762792435316988699)
,p_plugin_attribute_id=>wwv_flow_imp.id(762791728697988699)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762792891441988700)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762793102705988700)
,p_plugin_attribute_id=>wwv_flow_imp.id(762792891441988700)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762793541096988700)
,p_plugin_attribute_id=>wwv_flow_imp.id(762792891441988700)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762793923769988701)
,p_plugin_attribute_id=>wwv_flow_imp.id(762792891441988700)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762794396379988701)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762795880845988702)
,p_plugin_attribute_id=>wwv_flow_imp.id(762794396379988701)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762796226711988703)
,p_plugin_attribute_id=>wwv_flow_imp.id(762794396379988701)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762794661163988701)
,p_plugin_attribute_id=>wwv_flow_imp.id(762794396379988701)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762795013555988701)
,p_plugin_attribute_id=>wwv_flow_imp.id(762794396379988701)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762795459737988702)
,p_plugin_attribute_id=>wwv_flow_imp.id(762794396379988701)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762796674006988703)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762796950862988703)
,p_plugin_attribute_id=>wwv_flow_imp.id(762796674006988703)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762797386620988703)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2563005139149018969)
,p_plugin_id=>wwv_flow_imp.id(762783755844988689)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
