...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(762758237217988419)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762758569408988502)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762758843676988513)
,p_plugin_attribute_id=>wwv_flow_imp.id(762758569408988502)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762759211595988521)
,p_plugin_attribute_id=>wwv_flow_imp.id(762758569408988502)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762759646623988522)
,p_plugin_attribute_id=>wwv_flow_imp.id(762758569408988502)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762760025122988532)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(762758569408988502)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762760317177988534)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762760697734988534)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762760975729988534)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762761287271988534)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762761558375988535)
,p_plugin_attribute_id=>wwv_flow_imp.id(762761287271988534)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762761967285988535)
,p_plugin_attribute_id=>wwv_flow_imp.id(762761287271988534)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762762340108988535)
,p_plugin_attribute_id=>wwv_flow_imp.id(762761287271988534)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762762724011988536)
,p_plugin_attribute_id=>wwv_flow_imp.id(762761287271988534)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762763168883988536)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762763425528988536)
,p_plugin_attribute_id=>wwv_flow_imp.id(762763168883988536)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762763865752988537)
,p_plugin_attribute_id=>wwv_flow_imp.id(762763168883988536)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762764206439988537)
,p_plugin_attribute_id=>wwv_flow_imp.id(762763168883988536)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762764698005988537)
,p_plugin_attribute_id=>wwv_flow_imp.id(762763168883988536)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762765039008988537)
,p_plugin_attribute_id=>wwv_flow_imp.id(762763168883988536)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762765468261988538)
,p_plugin_attribute_id=>wwv_flow_imp.id(762763168883988536)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762765895774988538)
,p_plugin_attribute_id=>wwv_flow_imp.id(762763168883988536)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762766286553988538)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2562809079249102173)
,p_plugin_id=>wwv_flow_imp.id(762758237217988419)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
