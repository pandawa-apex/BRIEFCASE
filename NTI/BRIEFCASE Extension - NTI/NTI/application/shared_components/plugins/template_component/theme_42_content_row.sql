...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(762803182415988749)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2690040946935060447)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2690040391923060446)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2433148328192786933)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762804077497988754)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762804347802988754)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762804673812988755)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762804952623988756)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762805292127988756)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762805586185988757)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762805853844988757)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(762805292127988756)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2690040946935060447)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762806152650988757)
,p_plugin_attribute_id=>wwv_flow_imp.id(762805853844988757)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762806572410988758)
,p_plugin_attribute_id=>wwv_flow_imp.id(762805853844988757)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762806929695988758)
,p_plugin_attribute_id=>wwv_flow_imp.id(762805853844988757)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762807358895988759)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(762805853844988757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762807624734988759)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762807951669988760)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762808298885988760)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762808563680988760)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762808831423988761)
,p_plugin_attribute_id=>wwv_flow_imp.id(762808563680988760)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762809249319988761)
,p_plugin_attribute_id=>wwv_flow_imp.id(762808563680988760)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762809684381988762)
,p_plugin_attribute_id=>wwv_flow_imp.id(762808563680988760)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762810043399988762)
,p_plugin_attribute_id=>wwv_flow_imp.id(762808563680988760)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762810461652988762)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(762805586185988757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2690040391923060446)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762810718649988763)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762811021995988763)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762811325170988764)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762811606305988765)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762811943649988765)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762812246083988766)
,p_plugin_attribute_id=>wwv_flow_imp.id(762811943649988765)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762812667701988766)
,p_plugin_attribute_id=>wwv_flow_imp.id(762811943649988765)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762813092450988767)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762813347528988767)
,p_plugin_attribute_id=>wwv_flow_imp.id(762813092450988767)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762813798583988767)
,p_plugin_attribute_id=>wwv_flow_imp.id(762813092450988767)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762814157085988768)
,p_plugin_attribute_id=>wwv_flow_imp.id(762813092450988767)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762814527914988768)
,p_plugin_attribute_id=>wwv_flow_imp.id(762813092450988767)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762814991822988768)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762815210710988769)
,p_plugin_attribute_id=>wwv_flow_imp.id(762814991822988768)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762815612473988769)
,p_plugin_attribute_id=>wwv_flow_imp.id(762814991822988768)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762816010098988769)
,p_plugin_attribute_id=>wwv_flow_imp.id(762814991822988768)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762816421780988769)
,p_plugin_attribute_id=>wwv_flow_imp.id(762814991822988768)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762816842036988770)
,p_plugin_attribute_id=>wwv_flow_imp.id(762814991822988768)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762817211271988770)
,p_plugin_attribute_id=>wwv_flow_imp.id(762814991822988768)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762817656471988771)
,p_plugin_attribute_id=>wwv_flow_imp.id(762814991822988768)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762818053380988771)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762818368709988772)
,p_plugin_attribute_id=>wwv_flow_imp.id(762818053380988771)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762818737240988772)
,p_plugin_attribute_id=>wwv_flow_imp.id(762818053380988771)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762819196607988772)
,p_plugin_attribute_id=>wwv_flow_imp.id(762818053380988771)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762819549642988773)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762819852484988773)
,p_plugin_attribute_id=>wwv_flow_imp.id(762819549642988773)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762820207613988774)
,p_plugin_attribute_id=>wwv_flow_imp.id(762819549642988773)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762820686753988774)
,p_plugin_attribute_id=>wwv_flow_imp.id(762819549642988773)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762821056034988774)
,p_plugin_attribute_id=>wwv_flow_imp.id(762819549642988773)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762821498043988775)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762821776118988775)
,p_plugin_attribute_id=>wwv_flow_imp.id(762821498043988775)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762822149276988775)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762822452868988776)
,p_plugin_attribute_id=>wwv_flow_imp.id(762822149276988775)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762822883789988776)
,p_plugin_attribute_id=>wwv_flow_imp.id(762822149276988775)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762823245727988776)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(2433148328192786933)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762823573167988777)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762823867510988777)
,p_plugin_attribute_id=>wwv_flow_imp.id(762823573167988777)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762824226430988777)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762824586092988778)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2571254837150882061)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2571256096670886209)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2274303322255123631)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2557661208476475328)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2558340509206558432)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2571252902083837075)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2571254235473850932)
,p_plugin_id=>wwv_flow_imp.id(762803182415988749)
