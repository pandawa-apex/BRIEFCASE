...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(762773483126988667)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2562658928632020385)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762773957559988669)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762774201962988670)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762774505898988670)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762774840693988670)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762775116342988671)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(762779711075988681)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2562658928632020385)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762775488837988671)
,p_plugin_attribute_id=>wwv_flow_imp.id(762775116342988671)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762775817996988671)
,p_plugin_attribute_id=>wwv_flow_imp.id(762775116342988671)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762776215943988671)
,p_plugin_attribute_id=>wwv_flow_imp.id(762775116342988671)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762776603313988672)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(762775116342988671)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762776938577988672)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762777260057988672)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762777551424988672)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762777827386988673)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762778173467988673)
,p_plugin_attribute_id=>wwv_flow_imp.id(762777827386988673)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762778584290988673)
,p_plugin_attribute_id=>wwv_flow_imp.id(762777827386988673)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762778959756988679)
,p_plugin_attribute_id=>wwv_flow_imp.id(762777827386988673)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762779368061988680)
,p_plugin_attribute_id=>wwv_flow_imp.id(762777827386988673)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762779711075988681)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762780038404988682)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762780314137988682)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762780675547988682)
,p_plugin_attribute_id=>wwv_flow_imp.id(762780314137988682)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(762781097387988683)
,p_plugin_attribute_id=>wwv_flow_imp.id(762780314137988682)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762781483157988683)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2562791596065121888)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2562791004560114431)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2562846628230096310)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2562998845942967081)
,p_plugin_id=>wwv_flow_imp.id(762773483126988667)
