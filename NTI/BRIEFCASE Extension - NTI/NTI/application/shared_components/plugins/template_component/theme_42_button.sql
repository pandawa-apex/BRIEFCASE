...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(762800415860988740)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762800798679988741)
,p_plugin_id=>wwv_flow_imp.id(762800415860988740)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762801015058988742)
,p_plugin_id=>wwv_flow_imp.id(762800415860988740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762801389387988742)
,p_plugin_id=>wwv_flow_imp.id(762800415860988740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762801645980988743)
,p_plugin_id=>wwv_flow_imp.id(762800415860988740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762801966310988743)
,p_plugin_id=>wwv_flow_imp.id(762800415860988740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762802202105988743)
,p_plugin_id=>wwv_flow_imp.id(762800415860988740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762802540889988743)
,p_plugin_id=>wwv_flow_imp.id(762800415860988740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(762802864354988744)
,p_plugin_id=>wwv_flow_imp.id(762800415860988740)
,p_attribute_scope=>'COMPONENT'
