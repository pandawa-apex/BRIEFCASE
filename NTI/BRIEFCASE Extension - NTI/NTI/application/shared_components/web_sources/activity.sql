...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(18961385231193936)
,p_name=>'Activity'
...
,p_version_scn=>6202115442058
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(18961937972193941)
,p_web_src_module_id=>wwv_flow_imp.id(18961385231193936)
,p_name=>'company'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(18961515690193937)
,p_web_src_module_id=>wwv_flow_imp.id(18961385231193936)
,p_operation=>'GET'
