...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(21050897523573117)
,p_name=>'BF - User Access'
,p_static_id=>'bf_user_access'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(21042556532573093)
...
,p_credential_id=>wwv_flow_imp.id(21042299729573088)
...
,p_version_scn=>39509820736243
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(21051466652573126)
,p_web_src_module_id=>wwv_flow_imp.id(21050897523573117)
,p_name=>'company'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(21051082961573119)
,p_web_src_module_id=>wwv_flow_imp.id(21050897523573117)
,p_operation=>'GET'
