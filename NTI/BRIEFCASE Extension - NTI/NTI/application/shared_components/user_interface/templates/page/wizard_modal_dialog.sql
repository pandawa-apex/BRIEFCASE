...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(762597910489988056)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762598211262988056)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762598524187988056)
,p_page_template_id=>wwv_flow_imp.id(762597910489988056)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762598870964988057)
,p_page_template_id=>wwv_flow_imp.id(762597910489988056)
