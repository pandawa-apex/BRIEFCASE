...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(762602088889988058)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762602360242988058)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762602665540988058)
,p_page_template_id=>wwv_flow_imp.id(762602088889988058)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762602902277988058)
,p_page_template_id=>wwv_flow_imp.id(762602088889988058)
