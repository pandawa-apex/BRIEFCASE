...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(762580580010987934)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762580853912987991)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762581179831987993)
,p_page_template_id=>wwv_flow_imp.id(762580580010987934)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762581420835987993)
,p_page_template_id=>wwv_flow_imp.id(762580580010987934)
