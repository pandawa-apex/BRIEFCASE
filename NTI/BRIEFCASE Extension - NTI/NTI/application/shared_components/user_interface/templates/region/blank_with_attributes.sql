...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762616480935988101)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762616749006988101)
,p_plug_template_id=>wwv_flow_imp.id(762616480935988101)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762617034029988102)
,p_plug_template_id=>wwv_flow_imp.id(762616480935988101)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762617324753988102)
,p_plug_template_id=>wwv_flow_imp.id(762616480935988101)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762617685827988102)
,p_plug_template_id=>wwv_flow_imp.id(762616480935988101)
,p_name=>'Sub Regions'
