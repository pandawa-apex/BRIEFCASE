...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762617880766988102)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762618130104988102)
,p_plug_template_id=>wwv_flow_imp.id(762617880766988102)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762618477302988102)
,p_plug_template_id=>wwv_flow_imp.id(762617880766988102)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762618772849988102)
,p_plug_template_id=>wwv_flow_imp.id(762617880766988102)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762619098777988102)
,p_plug_template_id=>wwv_flow_imp.id(762617880766988102)
,p_name=>'Sub Regions'
