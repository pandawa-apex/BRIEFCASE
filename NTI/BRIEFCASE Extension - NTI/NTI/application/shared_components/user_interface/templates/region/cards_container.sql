...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762623504690988104)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762623875169988104)
,p_plug_template_id=>wwv_flow_imp.id(762623504690988104)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762624116887988104)
,p_plug_template_id=>wwv_flow_imp.id(762623504690988104)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762624422263988104)
,p_plug_template_id=>wwv_flow_imp.id(762623504690988104)
,p_name=>'Sub Regions'
