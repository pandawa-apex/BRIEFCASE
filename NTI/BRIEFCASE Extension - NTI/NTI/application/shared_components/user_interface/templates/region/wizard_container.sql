...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762700553090988142)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762700850109988142)
,p_plug_template_id=>wwv_flow_imp.id(762700553090988142)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762701190867988142)
,p_plug_template_id=>wwv_flow_imp.id(762700553090988142)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762701432007988142)
,p_plug_template_id=>wwv_flow_imp.id(762700553090988142)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762701778112988142)
,p_plug_template_id=>wwv_flow_imp.id(762700553090988142)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762702098415988143)
,p_plug_template_id=>wwv_flow_imp.id(762700553090988142)
