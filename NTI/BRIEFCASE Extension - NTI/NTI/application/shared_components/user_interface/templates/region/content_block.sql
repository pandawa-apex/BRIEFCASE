...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762645112750988117)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762645461734988117)
,p_plug_template_id=>wwv_flow_imp.id(762645112750988117)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762645713254988118)
,p_plug_template_id=>wwv_flow_imp.id(762645112750988117)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762646027398988118)
,p_plug_template_id=>wwv_flow_imp.id(762645112750988117)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762646364160988118)
,p_plug_template_id=>wwv_flow_imp.id(762645112750988117)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762646681037988118)
,p_plug_template_id=>wwv_flow_imp.id(762645112750988117)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762646965119988118)
,p_plug_template_id=>wwv_flow_imp.id(762645112750988117)
,p_name=>'Sub Regions'
