...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762680346569988135)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762680630611988135)
,p_plug_template_id=>wwv_flow_imp.id(762680346569988135)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762680974253988136)
,p_plug_template_id=>wwv_flow_imp.id(762680346569988135)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762681244086988136)
,p_plug_template_id=>wwv_flow_imp.id(762680346569988135)
,p_name=>'Sub Regions'
