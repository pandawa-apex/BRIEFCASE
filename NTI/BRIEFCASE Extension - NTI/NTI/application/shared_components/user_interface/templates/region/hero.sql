...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762649770980988120)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762650092346988123)
,p_plug_template_id=>wwv_flow_imp.id(762649770980988120)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762650385652988123)
,p_plug_template_id=>wwv_flow_imp.id(762649770980988120)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762650671575988123)
,p_plug_template_id=>wwv_flow_imp.id(762649770980988120)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762650922983988123)
,p_plug_template_id=>wwv_flow_imp.id(762649770980988120)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762651216522988124)
,p_plug_template_id=>wwv_flow_imp.id(762649770980988120)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
