...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762653247935988124)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762653577810988124)
,p_plug_template_id=>wwv_flow_imp.id(762653247935988124)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762653808996988125)
,p_plug_template_id=>wwv_flow_imp.id(762653247935988124)
,p_name=>'Sub Regions'
