...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762692896667988139)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762693127815988140)
,p_plug_template_id=>wwv_flow_imp.id(762692896667988139)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762693423694988140)
,p_plug_template_id=>wwv_flow_imp.id(762692896667988139)
,p_name=>'Tabs'
