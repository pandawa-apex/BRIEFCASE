...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762635367692988113)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762635689071988113)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762635988085988113)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762636288601988113)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762636540316988113)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762636845454988113)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762637198623988114)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762637467731988114)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762637735654988114)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762638050044988114)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762638398847988114)
,p_plug_template_id=>wwv_flow_imp.id(762635367692988113)
,p_name=>'Sub Regions'
