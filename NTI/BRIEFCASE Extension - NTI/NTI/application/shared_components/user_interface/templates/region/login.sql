...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762677810149988135)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762678115316988135)
,p_plug_template_id=>wwv_flow_imp.id(762677810149988135)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762678458305988135)
,p_plug_template_id=>wwv_flow_imp.id(762677810149988135)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762678705984988135)
,p_plug_template_id=>wwv_flow_imp.id(762677810149988135)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762679007961988135)
,p_plug_template_id=>wwv_flow_imp.id(762677810149988135)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762679336200988135)
,p_plug_template_id=>wwv_flow_imp.id(762677810149988135)
,p_name=>'Sub Regions'
