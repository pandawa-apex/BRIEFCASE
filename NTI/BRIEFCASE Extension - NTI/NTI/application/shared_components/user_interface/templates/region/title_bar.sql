...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762695407549988140)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762695774432988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762696079588988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762696389004988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762696663241988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762696916970988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762697270471988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762697517172988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762697825563988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762698181136988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762698490175988141)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762698799403988142)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762699077590988142)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762699381732988142)
,p_plug_template_id=>wwv_flow_imp.id(762695407549988140)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
