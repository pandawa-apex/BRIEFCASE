...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762673260752988133)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762673529554988133)
,p_plug_template_id=>wwv_flow_imp.id(762673260752988133)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762673879036988133)
,p_plug_template_id=>wwv_flow_imp.id(762673260752988133)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762674191153988133)
,p_plug_template_id=>wwv_flow_imp.id(762673260752988133)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762674433910988133)
,p_plug_template_id=>wwv_flow_imp.id(762673260752988133)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762674771512988133)
,p_plug_template_id=>wwv_flow_imp.id(762673260752988133)
,p_name=>'Sub Regions'
