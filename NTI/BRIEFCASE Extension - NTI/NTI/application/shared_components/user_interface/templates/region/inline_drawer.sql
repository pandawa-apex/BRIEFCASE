...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762663223647988129)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762663569817988129)
,p_plug_template_id=>wwv_flow_imp.id(762663223647988129)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762663891339988129)
,p_plug_template_id=>wwv_flow_imp.id(762663223647988129)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762664170438988129)
,p_plug_template_id=>wwv_flow_imp.id(762663223647988129)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762664478772988129)
,p_plug_template_id=>wwv_flow_imp.id(762663223647988129)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762664753080988130)
,p_plug_template_id=>wwv_flow_imp.id(762663223647988129)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762665056897988130)
,p_plug_template_id=>wwv_flow_imp.id(762663223647988129)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762665330174988130)
,p_plug_template_id=>wwv_flow_imp.id(762663223647988129)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762665612081988130)
,p_plug_template_id=>wwv_flow_imp.id(762663223647988129)
,p_name=>'Sub Regions'
