...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(762675379022988134)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762675685426988134)
,p_plug_template_id=>wwv_flow_imp.id(762675379022988134)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762675924236988134)
,p_plug_template_id=>wwv_flow_imp.id(762675379022988134)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(762676238290988134)
,p_plug_template_id=>wwv_flow_imp.id(762675379022988134)
,p_name=>'Button Start'
