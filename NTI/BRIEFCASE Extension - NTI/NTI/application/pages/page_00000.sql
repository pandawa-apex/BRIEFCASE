...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22673936367717347)
,p_name=>'P0_LOGIN_LINK'
,p_item_sequence=>10
,p_item_default=>'http://spare.ntiapps.net:8008/ords/r/ntiapex/briefcase-extension/login'
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22674059770717348)
