...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(763076735537153393)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(763099523269987504)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(763101203945987548)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(763076735537153393)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(763102633140987552)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(763076735537153393)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(763101835392987552)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(763076735537153393)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(763102242283987552)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(763076735537153393)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(763076089443153386)
,p_name=>'P10_USERNAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(763099523269987504)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(763099877773987504)
,p_name=>'P10_ID'
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(763099523269987504)
,p_item_source_plug_id=>wwv_flow_imp.id(763099523269987504)
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(763100202472987540)
,p_name=>'P10_TITLE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(763076114835153387)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(763101203945987548)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(763076233954153388)
,p_event_id=>wwv_flow_imp.id(763076114835153387)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(763103809527987563)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(763099523269987504)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(763076304070153389)
...
'DECLARE',
'    v_new_access_rights_id apx_access_rights.id%TYPE;',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(763102633140987552)
,p_process_success_message=>'Hak Akses sudah dibuat'
,p_internal_uid=>143196702848125723
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(763076526169153391)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(763102242283987552)
,p_process_success_message=>'Hak akses sudah diperbarui'
,p_internal_uid=>143196924947125725
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(763076678611153392)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(763101835392987552)
,p_process_success_message=>'Hak Akses sudah dihapus'
,p_internal_uid=>143197077389125726
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(763076468847153390)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(763103441282987562)
,p_process_sequence=>10
